...
public class Application implements IApplication {
	...
	public static StatusView getStatusView() {
		...
		if (PlatformUI.getWorkbench().getActiveWorkbenchWindow() != null
				&& PlatformUI.getWorkbench().getActiveWorkbenchWindow()
						.getActivePage() != null) {
			view = (de.umg.mi.idrt.ioe.view.StatusView) PlatformUI
					.getWorkbench().getActiveWorkbenchWindow().getActivePage()
					.findView("edu.goettingen.i2b2.importtool.view.StatusView");
		}
	...
	public static OntologyEditorView getOntologyView() {
		...
		if (PlatformUI.getWorkbench().getActiveWorkbenchWindow() != null
				&& PlatformUI.getWorkbench().getActiveWorkbenchWindow()
						.getActivePage() != null) {
			view = (OntologyEditorView) PlatformUI.getWorkbench()
					.getActiveWorkbenchWindow().getActivePage()
					.findView(Resource.ID.View.ONTOLOGY_VIEW);
		}
	...
	// PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(Resource.ID.View.EDITOR_SOURCE_VIEW);
	// }
	//
	// if (view == null){
	...
	// != null){
	//
	// view = (EditorTargetView)
	// PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(Resource.ID.View.EDITOR_TARGET_VIEW);
	// }
	//
	// if (view == null){
	...
	public static EditorSourceInfoView getEditorSourceInfoView() {
		...
		if (PlatformUI.getWorkbench().getActiveWorkbenchWindow() != null
			...
			view = (EditorSourceInfoView) PlatformUI.getWorkbench()
					.getActiveWorkbenchWindow().getActivePage()
					.findView(Resource.ID.View.EDITOR_SOURCE_INFO_VIEW);
		}

		if (view == null) {
			view = Activator.getDefault().getResource()
					.getEditorSourceInfoView();
		}
	...
	public static EditorTargetInfoView getEditorTargetInfoView() {
		...
		if (PlatformUI.getWorkbench().getActiveWorkbenchWindow() != null
			...
			view = (EditorTargetInfoView) PlatformUI.getWorkbench()
					.getActiveWorkbenchWindow().getActivePage()
					.findView(Resource.ID.View.EDITOR_TARGET_INFO_VIEW);
		}

		if (view == null) {
			view = Activator.getDefault().getResource()
					.getEditorTargetInfoView();
		}
