				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(createtable.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tJDBCRow_1 = "CREATE TABLE "
						...
						+ ".Tabelle  (     Titel VARCHAR (100),     Genre VARCHAR (30),     USK INTEGER,     Regisseur VARCHAR (30),     Laenge INTEGER,     Veroeffentlichung DATE  ) ";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = createtable.class.getClassLoader()
					.getResourceAsStream(
							"tos/createtable_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : createtable");
		}
...
/************************************************************************************************
 * 31948 characters generated by Talend Open Studio for Data Integration on the
 * 16. Oktober 2013 10:06:28 MESZ
 ************************************************************************************************/
