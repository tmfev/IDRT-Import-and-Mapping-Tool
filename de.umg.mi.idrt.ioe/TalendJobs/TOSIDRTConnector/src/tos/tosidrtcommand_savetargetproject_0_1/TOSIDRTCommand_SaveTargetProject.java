...
package tos.tosidrtcommand_savetargetproject_0_1;
...
/**
 * Job: TOSIDRTCommand_SaveTargetProject Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.3.1.r104014
 * @status 
 */
public class TOSIDRTCommand_SaveTargetProject implements TalendJob {
	...
	private final String jobName = "TOSIDRTCommand_SaveTargetProject";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					TOSIDRTCommand_SaveTargetProject.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TOSIDRTCommand_SaveTargetProject.this,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				TOSHandler.status("Doing TOS-Job \"SaveTargetProject\"...");
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_TOSIDRTCommand_SaveTargetProject = new byte[0];
		static byte[] commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject.length) {
					if (length < 1024
							&& commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject.length == 0) {
						commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject = new byte[1024];
					} else {
						commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TOS_TOSIDRTCommand_SaveTargetProject,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_TOSIDRTCommand_SaveTargetProject) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/I2B2ImportProject/GIT/de.umg.mi.idrt.ioe.git/de.umg.mi.idrt.ioe/temp/temp_TOS_Connector_file2.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/I2B2ImportProject/GIT/de.umg.mi.idrt.ioe.git/de.umg.mi.idrt.ioe/temp/temp_TOS_Connector_file2.csv",
								"ISO-8859-15", ";", "\n", true, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.TARGET_DB_SCHEMA = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
					...
					if (!((Object) ("C:/I2B2ImportProject/GIT/de.umg.mi.idrt.ioe.git/de.umg.mi.idrt.ioe/temp/temp_TOS_Connector_file2.csv") instanceof java.io.InputStream)) {
	...
	public void tJDBCConnection_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url_tJDBCConnection_2 = "jdbc:oracle:thin:@"
						+ context.OracleHost + ":" + context.OraclePort + ":"
						+ context.OracleDB;

				String userName_tJDBCConnection_2 = context.OracleUsername;
				String password_tJDBCConnection_2 = context.OraclePassword;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_3 = "select  TARGET_ID  from "
						+ context.OracleSchema + "." + context.TableIEOTarget
				...
				while (rs_tJDBCInput_3.next()) {
					...
					if ((counter == 0) && (targetIDCheck.TargetID != null)) {
						...
						context.DateCreated = TalendDate.parseDate(
								"yyyy/MM/dd", TalendDate.getDate("CCYY/MM/DD"));
						System.out
								.println("Saves this target project with TargetProjectID="
										+ context.TargetID + ".");
	...
	public void tJDBCConnection_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url_tJDBCConnection_4 = "jdbc:oracle:thin:@"
						+ context.OracleHost + ":" + context.OraclePort + ":"
						+ context.OracleDB;

				String userName_tJDBCConnection_4 = context.OracleUsername;
				String password_tJDBCConnection_4 = context.OraclePassword;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_2 = "select VERSION  from "
						+ context.OracleSchema + "." + context.TableIEOTarget
						+ " WHERE TARGETPROJECT_ID=" + context.TargetProjectID
						+ " and VERSION=" + context.Version + "";
	...
	public void tJDBCConnection_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url_tJDBCConnection_3 = "jdbc:oracle:thin:@"
						+ context.OracleHost + ":" + context.OraclePort + ":"
						+ context.OracleDB;

				String userName_tJDBCConnection_3 = context.OracleUsername;
				String password_tJDBCConnection_3 = context.OraclePassword;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/I2B2ImportProject/GIT/de.umg.mi.idrt.ioe.git/de.umg.mi.idrt.ioe/temp/temp_TOS_Connector_file2.csv";
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row4.NAME = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row4.DESCRIPTION = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row4.TARGET_DB_SCHEMA = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
	...
	public static void main(String[] args) {
		final TOSIDRTCommand_SaveTargetProject TOSIDRTCommand_SaveTargetProjectClass = new TOSIDRTCommand_SaveTargetProject();

		int exitCode = TOSIDRTCommand_SaveTargetProjectClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TOSIDRTCommand_SaveTargetProject.class
					.getClassLoader().getResourceAsStream(
							"tos/tosidrtcommand_savetargetproject_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : TOSIDRTCommand_SaveTargetProject");
		}
...
/************************************************************************************************
 * 154029 characters generated by Talend Open Studio for Data Integration on the
 * 22. Oktober 2013 16:39:49 MESZ
 ************************************************************************************************/
