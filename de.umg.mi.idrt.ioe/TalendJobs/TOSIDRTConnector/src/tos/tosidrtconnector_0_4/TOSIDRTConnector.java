	...
	public void tJDBCRow_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				connection_tJDBCRow_2 = java.sql.DriverManager.getConnection(
						connectionString_tJDBCRow_2,
						context.DB_StagingI2B2_Username,
						decryptedPassword_tJDBCRow_2);
	...
	public void tJDBCRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				connection_tJDBCRow_1 = java.sql.DriverManager.getConnection(
						connectionString_tJDBCRow_1,
						context.DB_StagingI2B2_Username,
						decryptedPassword_tJDBCRow_1);
...
/************************************************************************************************
 * 284983 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 5:10:27 PM CEST
 ************************************************************************************************/
