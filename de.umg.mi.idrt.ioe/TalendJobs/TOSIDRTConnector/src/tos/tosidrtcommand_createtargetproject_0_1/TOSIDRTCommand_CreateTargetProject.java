...
package tos.tosidrtcommand_createtargetproject_0_1;
...
public class TOSIDRTCommand_CreateTargetProject implements TalendJob {
	...
	public void tJDBCConnection_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String password_tJDBCConnection_2 = decryptedPassword_tJDBCConnection_2;
	...
	public static class targetInputStruct implements
		...
		final static byte[] commonByteArrayLock_TOS_TOSIDRTCommand_CreateTargetProject = new byte[0];
		static byte[] commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject.length) {
					if (length < 1024
							&& commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject.length == 0) {
						commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject = new byte[1024];
					} else {
						commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TOS_TOSIDRTCommand_CreateTargetProject,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_TOSIDRTCommand_CreateTargetProject) {
		...
		try {
			...
			java.io.InputStream inContext = TOSIDRTCommand_CreateTargetProject.class
					.getClassLoader().getResourceAsStream(
							"tos/tosidrtcommand_createtargetproject_0_1/contexts/"
 ...
 * October 14, 2014 5:10:26 PM CEST
 ************************************************************************************************/
