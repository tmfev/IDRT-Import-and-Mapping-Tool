...
package tos.transformation_to_target_0_1;
...
/**
 * Job: Transformation_to_target Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.3.1.r104014
 * @status 
 */
public class Transformation_to_target implements TalendJob {
	...
	private final String jobName = "Transformation_to_target";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Transformation_to_target.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Transformation_to_target.this,
	...
	public void tCreateTemporaryFile_8Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_8 = "talend_XXXX".replaceAll(
	...
	public void tCreateTemporaryFile_7Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_7 = "talend_XXXX".replaceAll(
						"XXXX", routines.TalendString.getAsciiRandomString(4)
								.toUpperCase());
	...
	public void tCreateTemporaryFile_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_6 = "talend_XXXX".replaceAll(
						"XXXX", routines.TalendString.getAsciiRandomString(4)
								.toUpperCase());
	...
	public void tCreateTemporaryFile_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_5 = "talend_XXXX".replaceAll(
						"XXXX", routines.TalendString.getAsciiRandomString(4)
								.toUpperCase());
	...
	public void tCreateTemporaryFile_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_4 = "talend_XXXX".replaceAll(
						"XXXX", routines.TalendString.getAsciiRandomString(4)
								.toUpperCase());
	...
	public void tCreateTemporaryFile_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_3 = "talend_XXXX".replaceAll(
						"XXXX", routines.TalendString.getAsciiRandomString(4)
								.toUpperCase());
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// context.DB_StagingI2B2_Host + ":"+context.DB_StagingI2B2_Port
				// + ":" + context.DB_StagingI2B2_Instance;
				// System.out.println(context.DB_TargetI2B2_jdbcurl);
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_Transformation_to_target = new byte[0];
		static byte[] commonByteArray_TOS_Transformation_to_target = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_Transformation_to_target.length) {
					if (length < 1024
							&& commonByteArray_TOS_Transformation_to_target.length == 0) {
						commonByteArray_TOS_Transformation_to_target = new byte[1024];
					} else {
						commonByteArray_TOS_Transformation_to_target = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_Transformation_to_target, 0,
						length);
				strReturn = new String(
						commonByteArray_TOS_Transformation_to_target, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_Transformation_to_target) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					if (filetFileOutputDelimited_1.length() == 0) {
						...
						outtFileOutputDelimited_1.write("SOURCE_PATH");
						...
						outtFileOutputDelimited_1
								.write("STARTDATE_SOURCE_PATH");

						outtFileOutputDelimited_1
								.write(OUT_DELIM_tFileOutputDelimited_1);

						outtFileOutputDelimited_1.write("ENDDATE_SOURCE_PATH");
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < column_index_tJDBCInput_1) {
							row1.SOURCE_PATH = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(column_index_tJDBCInput_1);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.SOURCE_PATH = tmpContent_tJDBCInput_1;
							} else {
								row1.SOURCE_PATH = null;
							}
						...
						if (colQtyInRs_tJDBCInput_1 < column_index_tJDBCInput_1) {
							row1.STARTDATE_SOURCE_PATH = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(column_index_tJDBCInput_1);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.STARTDATE_SOURCE_PATH = tmpContent_tJDBCInput_1;
							} else {
								row1.STARTDATE_SOURCE_PATH = null;
							}
						...
						if (colQtyInRs_tJDBCInput_1 < column_index_tJDBCInput_1) {
							row1.ENDDATE_SOURCE_PATH = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(column_index_tJDBCInput_1);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ENDDATE_SOURCE_PATH = tmpContent_tJDBCInput_1;
							} else {
								row1.ENDDATE_SOURCE_PATH = null;
							}
						...
						if (row1.STARTDATE_SOURCE_PATH != null) {

							sb_tFileOutputDelimited_1.append(

							row1.STARTDATE_SOURCE_PATH
						...
						if (row1.ENDDATE_SOURCE_PATH != null) {

							sb_tFileOutputDelimited_1.append(

							row1.ENDDATE_SOURCE_PATH
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fileName_tFileOutputDelimited_14 = (new java.io.File(
						"C:/Desktop/IOE/output/encounter_mapping.csv"))
						.getAbsolutePath().replace("\\", "/");
						...
						try {
							...
							while (fid_tFileInputDelimited_1 != null
								...
								try {
									...
									from_OE_ONT.SOURCE_PATH = fid_tFileInputDelimited_1
											.get(columnIndexWithD_tFileInputDelimited_1);
									...
									from_OE_ONT.STARTDATE_SOURCE_PATH = fid_tFileInputDelimited_1
											.get(columnIndexWithD_tFileInputDelimited_1);

									columnIndexWithD_tFileInputDelimited_1 = 7;

									from_OE_ONT.ENDDATE_SOURCE_PATH = fid_tFileInputDelimited_1
											.get(columnIndexWithD_tFileInputDelimited_1);
								...
								if (from_OE_ONT != null) {
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										from_src_ontHashKey.C_FULLNAME = from_OE_ONT.SOURCE_PATH;
									...
									while ((tHash_Lookup_from_src_ont != null && tHash_Lookup_from_src_ont
										...
										if (target_ont != null) {
											...
											if (target_ont.C_SYNONYM_CD != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_SYNONYM_CD
											...
											if (target_ont.C_VISUALATTRIBUTES != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_VISUALATTRIBUTES
											...
											if (target_ont.C_TOTALNUM != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_TOTALNUM
																.setScale(
																		0,
																		java.math.RoundingMode.HALF_UP)
																.toPlainString()
											...
											if (target_ont.C_BASECODE != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_BASECODE
											...
											if (target_ont.C_METADATAXML != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_METADATAXML
											...
											if (target_ont.C_FACTTABLECOLUMN != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_FACTTABLECOLUMN
											...
											if (target_ont.C_TABLENAME != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_TABLENAME
											...
											if (target_ont.C_COLUMNNAME != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_COLUMNNAME
											...
											if (target_ont.C_COLUMNDATATYPE != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_COLUMNDATATYPE
											...
											if (target_ont.C_OPERATOR != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_OPERATOR
											...
											if (target_ont.C_DIMCODE != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_DIMCODE
											...
											if (target_ont.C_COMMENT != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_COMMENT
											...
											if (target_ont.C_TOOLTIP != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.C_TOOLTIP
											...
											if (target_ont.M_APPLIED_PATH != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.M_APPLIED_PATH
											...
											if (target_ont.UPDATE_DATE != null) {
											...
											if (target_ont.DOWNLOAD_DATE != null) {
											...
											if (target_ont.IMPORT_DATE != null) {
											...
											if (target_ont.SOURCESYSTEM_CD != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.SOURCESYSTEM_CD
											...
											if (target_ont.VALUETYPE_CD != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.VALUETYPE_CD
											...
											if (target_ont.M_EXCLUSION_CD != null) {

												sb_tFileOutputDelimited_4
														.append(

														target_ont.M_EXCLUSION_CD
										...
										if (to_cd_dim != null) {
											...
											if (to_conc_dim != null) {
												...
												if (to_conc_dim.CONCEPT_CD != null) {

													sb_tFileOutputDelimited_5
															.append(

															to_conc_dim.CONCEPT_CD
												...
												if (to_conc_dim.NAME_CHAR != null) {

													sb_tFileOutputDelimited_5
															.append(

															to_conc_dim.NAME_CHAR
												...
												if (to_conc_dim.CONCEPT_BLOB != null) {

													sb_tFileOutputDelimited_5
															.append(

															to_conc_dim.CONCEPT_BLOB
												...
												if (to_conc_dim.UPDATE_DATE != null) {
												...
												if (to_conc_dim.DOWNLOAD_DATE != null) {
												...
												if (to_conc_dim.IMPORT_DATE != null) {
												...
												if (to_conc_dim.SOURCESYSTEM_CD != null) {

													sb_tFileOutputDelimited_5
															.append(

															to_conc_dim.SOURCESYSTEM_CD
												...
												if (to_conc_dim.UPLOAD_ID != null) {

													sb_tFileOutputDelimited_5
															.append(

															to_conc_dim.UPLOAD_ID
							...
							try {
								...
								while (fid_tFileInputDelimited_5 != null
									...
									try {
										...
										from_oe_target_ont.SOURCE_PATH = fid_tFileInputDelimited_5
												.get(columnIndexWithD_tFileInputDelimited_5);
										...
										from_oe_target_ont.STARTDATE_SOURCE_PATH = fid_tFileInputDelimited_5
												.get(columnIndexWithD_tFileInputDelimited_5);

										columnIndexWithD_tFileInputDelimited_5 = 7;

										from_oe_target_ont.ENDDATE_SOURCE_PATH = fid_tFileInputDelimited_5
												.get(columnIndexWithD_tFileInputDelimited_5);
									...
									if (from_oe_target_ont != null) {
										...
										if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
											...
											from_src_conc_dimHashKey.CONCEPT_PATH = from_oe_target_ont.SOURCE_PATH;
										...
										while ((tHash_Lookup_from_src_conc_dim != null && tHash_Lookup_from_src_conc_dim
											...
											{ // start of Var scope
												...
												to_tmap_tmp.SOURCE_PATH = from_oe_target_ont.SOURCE_PATH;
												...
												to_tmap_tmp.STARTDATE_SOURCE_PATH = from_oe_target_ont.STARTDATE_SOURCE_PATH;
												to_tmap_tmp.ENDDATE_SOURCE_PATH = from_oe_target_ont.ENDDATE_SOURCE_PATH;
												to_tmap = to_tmap_tmp;
												// ###############################
												...
												while ((tHash_Lookup_from_srxc_obsfct != null && tHash_Lookup_from_srxc_obsfct
													...
													{ // start of Var scope
														...
														if (!rejectedInnerJoin_tMap_4) {
															...
															to_obs_fct_tmp.START_DATE = to_tmap.STARTDATE_SOURCE_PATH;
															...
															to_obs_fct_tmp.END_DATE = to_tmap.ENDDATE_SOURCE_PATH;
													...
													if (to_obs_fct != null) {
														...
														// schema and output
														// schema
														row5.ENCOUNTER_NUM = to_obs_fct.ENCOUNTER_NUM;
														row5.PATIENT_NUM = to_obs_fct.PATIENT_NUM;
														// row5.CONCEPT_CD =
														// to_obs_fct.CONCEPT_CD;

														if (to_obs_fct.CONCEPT_CD
																.lastIndexOf("|") > 0) {
															StringBuilder b = new StringBuilder(
																	to_obs_fct.CONCEPT_CD);
															b.replace(
															...
															row5.CONCEPT_CD = to_obs_fct.CONCEPT_CD;
														}

														row5.PROVIDER_ID = to_obs_fct.PROVIDER_ID;
														if (to_obs_fct.START_DATE
																.length() > 0)
															row5.START_DATE = TalendDate
																	.parseDate(
																			"yyyy-MM-dd",
																			to_obs_fct.START_DATE);
														else {
															// "dd-MM-yyyy"
														...
														row5.MODIFIER_CD = to_obs_fct.MODIFIER_CD;
														row5.INSTANCE_NUM = to_obs_fct.INSTANCE_NUM;
														row5.VALTYPE_CD = to_obs_fct.VALTYPE_CD;
														row5.TVAL_CHAR = to_obs_fct.TVAL_CHAR;
														row5.NVAL_NUM = to_obs_fct.NVAL_NUM;
														row5.VALUEFLAG_CD = to_obs_fct.VALUEFLAG_CD;
														row5.QUANTITY_NUM = to_obs_fct.QUANTITY_NUM;
														row5.UNITS_CD = to_obs_fct.UNITS_CD;
														if (to_obs_fct.END_DATE
																.length() > 0)
															...
															row5.END_DATE = null;
														row5.LOCATION_CD = to_obs_fct.LOCATION_CD;
														row5.OBSERVATION_BLOB = to_obs_fct.OBSERVATION_BLOB;
														row5.CONFIDENCE_NUM = to_obs_fct.CONFIDENCE_NUM;
														row5.UPDATE_DATE = to_obs_fct.UPDATE_DATE;
														row5.DOWNLOAD_DATE = to_obs_fct.DOWNLOAD_DATE;
														row5.IMPORT_DATE = to_obs_fct.IMPORT_DATE;
														row5.SOURCESYSTEM_CD = to_obs_fct.SOURCESYSTEM_CD;
														row5.UPLOAD_ID = to_obs_fct.UPLOAD_ID;
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							if (temp.length() > 0) {
								...
								from_srxc_obsfct.START_DATE = ParserUtils
							...
							if (temp.length() > 0) {
								...
								from_srxc_obsfct.END_DATE = ParserUtils
										.parseTo_Date(temp, "yyyy-MM-dd");
	...
	public static void main(String[] args) {
		final Transformation_to_target Transformation_to_targetClass = new Transformation_to_target();

		int exitCode = Transformation_to_targetClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Transformation_to_target.class
					.getClassLoader().getResourceAsStream(
							"tos/transformation_to_target_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Transformation_to_target");
		}
...
/************************************************************************************************
 * 727409 characters generated by Talend Open Studio for Data Integration on the
 * 16. Oktober 2013 13:48:32 MESZ
 ************************************************************************************************/
