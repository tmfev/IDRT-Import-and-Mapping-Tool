			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.DB_StagingI2B2_WHType.equalsIgnoreCase("i2b2")) {
					...
					if (context.DB_StagingI2B2_DatabaseType
						...
						context.currentQuery = "select exists ( select 1 from "
...
/************************************************************************************************
 * 129007 characters generated by Talend Open Studio for Data Integration on the
 * March 16, 2015 2:58:55 PM CET
 ************************************************************************************************/
