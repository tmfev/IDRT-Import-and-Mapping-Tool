...
package i2b2_postgres2.database_rebuild_indexing_0_1;
...
/**
 * Job: Database_Rebuild_Indexing Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class Database_Rebuild_Indexing implements TalendJob {
	...
	private final String jobName = "Database_Rebuild_Indexing";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Database_Rebuild_Indexing.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Database_Rebuild_Indexing.this,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("Rebuild Indexing for "
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Object[] values_tForeach_1 = new Object[] {
						"ALTER index  " + context.DB_StagingI2B2_Schema
								+ ".FACT_CNPT_PAT_ENCT_IDX rebuild",
						"ALTER index  " + context.DB_StagingI2B2_Schema
								+ ".FACT_PATCON_DATE_PRVD_IDX rebuild",
						"ALTER index  " + context.DB_StagingI2B2_Schema
								+ ".FACT_NOLOB rebuild",
						"ALTER index  " + context.DB_StagingI2B2_Schema
								+ ".OF_CTX_BLOB rebuild", "commit", };
	...
	public static void main(String[] args) {
		final Database_Rebuild_Indexing Database_Rebuild_IndexingClass = new Database_Rebuild_Indexing();

		int exitCode = Database_Rebuild_IndexingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Database_Rebuild_Indexing.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/database_rebuild_indexing_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Database_Rebuild_Indexing");
		}
...
/************************************************************************************************
 * 44298 characters generated by Talend Open Studio for Data Integration on the
 * March 16, 2015 2:59:00 PM CET
 ************************************************************************************************/
