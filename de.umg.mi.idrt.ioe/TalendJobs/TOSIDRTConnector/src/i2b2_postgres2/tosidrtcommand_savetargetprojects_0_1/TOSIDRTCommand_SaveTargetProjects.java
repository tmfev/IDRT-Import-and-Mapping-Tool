...
package i2b2_postgres2.tosidrtcommand_savetargetprojects_0_1;
...
public class TOSIDRTCommand_SaveTargetProjects implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects.length == 0) {
						commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_TOSIDRTCommand_SaveTargetProjects) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.DB_StagingI2B2_WHType.equalsIgnoreCase("i2b2"))
					context.currentQuery = "select  TARGETPROJECT_ID  from "
							+ context.DB_StagingI2B2_Schema + "."
							+ context.TableIEOTargetProject
							+ " ORDER BY TARGETPROJECT_ID DESC";
				else {
					context.currentQuery = "select  TARGETPROJECT_ID  from i2b2metadata."
							+ context.TableIEOTargetProject
							+ " ORDER BY TARGETPROJECT_ID DESC";
	...
	public void tJava_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.DB_StagingI2B2_WHType.equalsIgnoreCase("i2b2"))
					context.currentQuery = "select  TARGET_ID  from "
							+ context.DB_StagingI2B2_Schema + "."
							+ context.TableIEOTarget
							+ " ORDER BY TARGET_ID DESC";
				else {
					context.currentQuery = "select  TARGET_ID  from i2b2metadata."
							+ context.TableIEOTarget
							+ " ORDER BY TARGET_ID DESC";
	...
	public void tJDBCConnection_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tJDBCConnection_4 = context.DB_StagingI2B2_Username;

				final String decryptedPassword_tJDBCConnection_4 = context.DB_StagingI2B2_Password;
	...
	public void tJava_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (context.DB_StagingI2B2_WHType.equalsIgnoreCase("i2b2"))
					context.currentQuery = "select VERSION  from "
							+ context.DB_StagingI2B2_Schema + "."
							+ context.TableIEOTarget
					...
					context.currentQuery = "select VERSION  from i2b2metadata."
							+ context.TableIEOTarget
							+ " WHERE TARGETPROJECT_ID="
							+ context.TargetProjectID
							+ " ORDER BY VERSION DESC";
	...
	public void tJDBCConnection_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tJDBCConnection_3 = context.DB_StagingI2B2_Username;

				final String decryptedPassword_tJDBCConnection_3 = context.DB_StagingI2B2_Password;
		...
		try {
			...
			java.io.InputStream inContext = TOSIDRTCommand_SaveTargetProjects.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/tosidrtcommand_savetargetprojects_0_1/contexts/"
...
/************************************************************************************************
 * 213781 characters generated by Talend Open Studio for Data Integration on the
