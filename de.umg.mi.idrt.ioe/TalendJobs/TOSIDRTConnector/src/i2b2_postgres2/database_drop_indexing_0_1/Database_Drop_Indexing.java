...
package i2b2_postgres2.database_drop_indexing_0_1;
...
/**
 * Job: Database_Drop_Indexing Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class Database_Drop_Indexing implements TalendJob {
	...
	private final String jobName = "Database_Drop_Indexing";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Database_Drop_Indexing.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Database_Drop_Indexing.this, new Object[] {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("Drop Indexing for "
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Object[] values_tForeach_2 = new Object[] {
						"DROP index IF EXISTS  "
								+ context.DB_StagingI2B2_Schema
								+ ".of_idx_allobservation_fact",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_clusteredconcept",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_encounter_patient",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_modifier",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_sourcesystem_cd",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_start_date",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_idx_uploadid",
						"DROP index IF EXISTS " + context.DB_StagingI2B2_Schema
								+ ".of_text_search_unique", "commit", };
	...
	public static void main(String[] args) {
		final Database_Drop_Indexing Database_Drop_IndexingClass = new Database_Drop_Indexing();

		int exitCode = Database_Drop_IndexingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Database_Drop_Indexing.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/database_drop_indexing_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Database_Drop_Indexing");
		}
...
/************************************************************************************************
 * 52847 characters generated by Talend Open Studio for Data Integration on the
 * March 16, 2015 2:58:56 PM CET
 ************************************************************************************************/
