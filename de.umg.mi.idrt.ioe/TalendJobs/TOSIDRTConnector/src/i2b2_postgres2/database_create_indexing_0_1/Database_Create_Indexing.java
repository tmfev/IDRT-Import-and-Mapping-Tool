...
package i2b2_postgres2.database_create_indexing_0_1;
 ...
 * @status 
 */
public class Database_Create_Indexing implements TalendJob {
	...
	private final String jobName = "Database_Create_Indexing";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Database_Create_Indexing.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Database_Create_Indexing.this,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("Create Indexing for "
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Object[] values_tForeach_1 = new Object[] {
						...
						"CREATE INDEX "
								...
								+ ".OF_CTX_BLOB ON "
								+ context.DB_StagingI2B2_Schema
								+ ".OBSERVATION_FACT (OBSERVATION_BLOB) INDEXTYPE IS CTXSYS.CONTEXT",
						"commit", };
	...
	public static void main(String[] args) {
		final Database_Create_Indexing Database_Create_IndexingClass = new Database_Create_Indexing();

		int exitCode = Database_Create_IndexingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Database_Create_Indexing.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/database_create_indexing_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Database_Create_Indexing");
		}
