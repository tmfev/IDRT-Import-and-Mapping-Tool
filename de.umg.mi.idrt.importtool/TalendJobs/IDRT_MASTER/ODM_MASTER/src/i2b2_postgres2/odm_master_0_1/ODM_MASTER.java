...
package i2b2_postgres2.odm_master_0_1;
...
public class ODM_MASTER implements TalendJob {
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.odm_extract_pd_0_1.ODM_Extract_PD childJob_tRunJob_2 = new i2b2_postgres2.odm_extract_pd_0_1.ODM_Extract_PD();
				// pass DataSources
	...
	public static class row14Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_ODM_MASTER = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_ODM_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_ODM_MASTER.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_ODM_MASTER.length == 0) {
						commonByteArray_I2B2_POSTGRES2_ODM_MASTER = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_ODM_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_I2B2_POSTGRES2_ODM_MASTER, 0,
						length);
				strReturn = new String(
						commonByteArray_I2B2_POSTGRES2_ODM_MASTER, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_ODM_MASTER) {
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.idrt_truncate_tables_0_1.IDRT_Truncate_Tables childJob_tRunJob_12 = new i2b2_postgres2.idrt_truncate_tables_0_1.IDRT_Truncate_Tables();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_5.put("basedir", context.basedir);
				...
				i2b2_postgres2.odm_extract_pd_with_xslt_0_1.ODM_Extract_PD_With_XSLT childJob_tRunJob_5 = new i2b2_postgres2.odm_extract_pd_with_xslt_0_1.ODM_Extract_PD_With_XSLT();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.odm_create_ontology_1_1.ODM_Create_Ontology childJob_tRunJob_1 = new i2b2_postgres2.odm_create_ontology_1_1.ODM_Create_Ontology();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_10.put("IndexDrop", context.IndexDrop);

				parentContextMap_tRunJob_10.put("IndexStop", context.IndexStop);
				...
				parentContextMap_tRunJob_10.put("DB_StagingI2B2_WHType",
						context.DB_StagingI2B2_WHType);
				...
				i2b2_postgres2.idrt_set_patient_count_0_1.IDRT_Set_Patient_Count childJob_tRunJob_10 = new i2b2_postgres2.idrt_set_patient_count_0_1.IDRT_Set_Patient_Count();
				// pass DataSources
	...
	public void tJava_21Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT",
						"CONNECTION:SUBJOB_OK:tJava_21:OnSubjobOk3", "", Thread
								.currentThread().getId() + "", "", "", "", "",
						"");
			}
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_6.put("basedir", context.basedir);
				...
				parentContextMap_tRunJob_6.put("concept_path",
						context.concept_path);
				...
				parentContextMap_tRunJob_6.put("folderODM", context.folderODM);
				...
				parentContextMap_tRunJob_6.put("importCodelist",
						context.importCodelist);

				parentContextMap_tRunJob_6.put("importSingleFile",
						context.importSingleFile);

				parentContextMap_tRunJob_6.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_6.put("ItemData", context.ItemData);

				parentContextMap_tRunJob_6.put("ItemDataAny",
						context.ItemDataAny);

				parentContextMap_tRunJob_6.put("ItemDataBase64Binary",
						context.ItemDataBase64Binary);

				parentContextMap_tRunJob_6.put("ItemDataBase64Float",
						context.ItemDataBase64Float);

				parentContextMap_tRunJob_6.put("ItemDataBoolean",
						context.ItemDataBoolean);

				parentContextMap_tRunJob_6.put("ItemDataDate",
						context.ItemDataDate);

				parentContextMap_tRunJob_6.put("ItemDataDatetime",
						context.ItemDataDatetime);

				parentContextMap_tRunJob_6.put("ItemDataDouble",
						context.ItemDataDouble);

				parentContextMap_tRunJob_6.put("ItemDataDurationDatetime",
						context.ItemDataDurationDatetime);

				parentContextMap_tRunJob_6.put("ItemDataFloat",
						context.ItemDataFloat);

				parentContextMap_tRunJob_6.put("ItemDataHexBinary",
						context.ItemDataHexBinary);

				parentContextMap_tRunJob_6.put("ItemDataHexFloat",
						context.ItemDataHexFloat);

				parentContextMap_tRunJob_6.put("ItemDataIncompleteDatetime",
						context.ItemDataIncompleteDatetime);

				parentContextMap_tRunJob_6.put("ItemDataInteger",
						context.ItemDataInteger);

				parentContextMap_tRunJob_6.put("ItemDataIntervalDatetime",
						context.ItemDataIntervalDatetime);

				parentContextMap_tRunJob_6.put("ItemDataPartialDate",
						context.ItemDataPartialDate);

				parentContextMap_tRunJob_6.put("ItemDataPartialDatetime",
						context.ItemDataPartialDatetime);

				parentContextMap_tRunJob_6.put("ItemDataPartialTime",
						context.ItemDataPartialTime);

				parentContextMap_tRunJob_6.put("ItemDataString",
						context.ItemDataString);

				parentContextMap_tRunJob_6.put("ItemDataTime",
						context.ItemDataTime);

				parentContextMap_tRunJob_6.put("ItemDataURI",
						context.ItemDataURI);
				...
				parentContextMap_tRunJob_6.put("xslt", context.xslt);

				parentContextMap_tRunJob_6.put("xslt_namespace",
						context.xslt_namespace);
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_7.put("basedir", context.basedir);
				...
				parentContextMap_tRunJob_7.put("concept_path",
						context.concept_path);
				...
				parentContextMap_tRunJob_7.put("folderODM", context.folderODM);
				...
				parentContextMap_tRunJob_7.put("importCodelist",
						context.importCodelist);

				parentContextMap_tRunJob_7.put("importSingleFile",
						context.importSingleFile);

				parentContextMap_tRunJob_7.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_7.put("ItemData", context.ItemData);

				parentContextMap_tRunJob_7.put("ItemDataAny",
						context.ItemDataAny);

				parentContextMap_tRunJob_7.put("ItemDataBase64Binary",
						context.ItemDataBase64Binary);

				parentContextMap_tRunJob_7.put("ItemDataBase64Float",
						context.ItemDataBase64Float);

				parentContextMap_tRunJob_7.put("ItemDataBoolean",
						context.ItemDataBoolean);

				parentContextMap_tRunJob_7.put("ItemDataDate",
						context.ItemDataDate);

				parentContextMap_tRunJob_7.put("ItemDataDatetime",
						context.ItemDataDatetime);

				parentContextMap_tRunJob_7.put("ItemDataDouble",
						context.ItemDataDouble);

				parentContextMap_tRunJob_7.put("ItemDataDurationDatetime",
						context.ItemDataDurationDatetime);

				parentContextMap_tRunJob_7.put("ItemDataFloat",
						context.ItemDataFloat);

				parentContextMap_tRunJob_7.put("ItemDataHexBinary",
						context.ItemDataHexBinary);

				parentContextMap_tRunJob_7.put("ItemDataHexFloat",
						context.ItemDataHexFloat);

				parentContextMap_tRunJob_7.put("ItemDataIncompleteDatetime",
						context.ItemDataIncompleteDatetime);

				parentContextMap_tRunJob_7.put("ItemDataInteger",
						context.ItemDataInteger);

				parentContextMap_tRunJob_7.put("ItemDataIntervalDatetime",
						context.ItemDataIntervalDatetime);

				parentContextMap_tRunJob_7.put("ItemDataPartialDate",
						context.ItemDataPartialDate);

				parentContextMap_tRunJob_7.put("ItemDataPartialDatetime",
						context.ItemDataPartialDatetime);

				parentContextMap_tRunJob_7.put("ItemDataPartialTime",
						context.ItemDataPartialTime);

				parentContextMap_tRunJob_7.put("ItemDataString",
						context.ItemDataString);

				parentContextMap_tRunJob_7.put("ItemDataTime",
						context.ItemDataTime);

				parentContextMap_tRunJob_7.put("ItemDataURI",
						context.ItemDataURI);
				...
				parentContextMap_tRunJob_7.put("xslt", context.xslt);

				parentContextMap_tRunJob_7.put("xslt_namespace",
						context.xslt_namespace);
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_9.put("basedir", context.basedir);
				...
				parentContextMap_tRunJob_9.put("concept_path",
						context.concept_path);

				parentContextMap_tRunJob_9.put("currentFile",
						context.currentFile);

				parentContextMap_tRunJob_9.put("encoding", context.encoding);

				parentContextMap_tRunJob_9
						.put("folderMain", context.folderMain);

				parentContextMap_tRunJob_9.put("folderODM", context.folderODM);
				...
				parentContextMap_tRunJob_9.put("importCodelist",
						context.importCodelist);

				parentContextMap_tRunJob_9.put("importSingleFile",
						context.importSingleFile);

				parentContextMap_tRunJob_9.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_9.put("ItemData", context.ItemData);

				parentContextMap_tRunJob_9.put("ItemDataAny",
						context.ItemDataAny);

				parentContextMap_tRunJob_9.put("ItemDataBase64Binary",
						context.ItemDataBase64Binary);

				parentContextMap_tRunJob_9.put("ItemDataBase64Float",
						context.ItemDataBase64Float);

				parentContextMap_tRunJob_9.put("ItemDataBoolean",
						context.ItemDataBoolean);

				parentContextMap_tRunJob_9.put("ItemDataDate",
						context.ItemDataDate);

				parentContextMap_tRunJob_9.put("ItemDataDatetime",
						context.ItemDataDatetime);

				parentContextMap_tRunJob_9.put("ItemDataDouble",
						context.ItemDataDouble);

				parentContextMap_tRunJob_9.put("ItemDataDurationDatetime",
						context.ItemDataDurationDatetime);

				parentContextMap_tRunJob_9.put("ItemDataFloat",
						context.ItemDataFloat);

				parentContextMap_tRunJob_9.put("ItemDataHexBinary",
						context.ItemDataHexBinary);

				parentContextMap_tRunJob_9.put("ItemDataHexFloat",
						context.ItemDataHexFloat);

				parentContextMap_tRunJob_9.put("ItemDataIncompleteDatetime",
						context.ItemDataIncompleteDatetime);

				parentContextMap_tRunJob_9.put("ItemDataInteger",
						context.ItemDataInteger);

				parentContextMap_tRunJob_9.put("ItemDataIntervalDatetime",
						context.ItemDataIntervalDatetime);

				parentContextMap_tRunJob_9.put("ItemDataPartialDate",
						context.ItemDataPartialDate);

				parentContextMap_tRunJob_9.put("ItemDataPartialDatetime",
						context.ItemDataPartialDatetime);

				parentContextMap_tRunJob_9.put("ItemDataPartialTime",
						context.ItemDataPartialTime);

				parentContextMap_tRunJob_9.put("ItemDataString",
						context.ItemDataString);

				parentContextMap_tRunJob_9.put("ItemDataTime",
						context.ItemDataTime);

				parentContextMap_tRunJob_9.put("ItemDataURI",
						context.ItemDataURI);
				...
				parentContextMap_tRunJob_9.put("xslt", context.xslt);

				parentContextMap_tRunJob_9.put("xslt_namespace",
						context.xslt_namespace);
				...
				i2b2_postgres2.database_create_indexing_0_1.Database_Create_Indexing childJob_tRunJob_9 = new i2b2_postgres2.database_create_indexing_0_1.Database_Create_Indexing();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_11.put("basedir", context.basedir);
				...
				parentContextMap_tRunJob_11.put("concept_cd",
						context.concept_cd);

				parentContextMap_tRunJob_11.put("concept_path",
						context.concept_path);

				parentContextMap_tRunJob_11.put("currentFile",
						context.currentFile);

				parentContextMap_tRunJob_11.put("encoding", context.encoding);

				parentContextMap_tRunJob_11.put("folderMain",
						context.folderMain);

				parentContextMap_tRunJob_11.put("folderODM", context.folderODM);
				...
				parentContextMap_tRunJob_11.put("importCodelist",
						context.importCodelist);

				parentContextMap_tRunJob_11.put("importSingleFile",
						context.importSingleFile);

				parentContextMap_tRunJob_11.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_11.put("ItemData", context.ItemData);

				parentContextMap_tRunJob_11.put("ItemDataAny",
						context.ItemDataAny);

				parentContextMap_tRunJob_11.put("ItemDataBase64Binary",
						context.ItemDataBase64Binary);

				parentContextMap_tRunJob_11.put("ItemDataBase64Float",
						context.ItemDataBase64Float);

				parentContextMap_tRunJob_11.put("ItemDataBoolean",
						context.ItemDataBoolean);

				parentContextMap_tRunJob_11.put("ItemDataDate",
						context.ItemDataDate);

				parentContextMap_tRunJob_11.put("ItemDataDatetime",
						context.ItemDataDatetime);

				parentContextMap_tRunJob_11.put("ItemDataDouble",
						context.ItemDataDouble);

				parentContextMap_tRunJob_11.put("ItemDataDurationDatetime",
						context.ItemDataDurationDatetime);

				parentContextMap_tRunJob_11.put("ItemDataFloat",
						context.ItemDataFloat);

				parentContextMap_tRunJob_11.put("ItemDataHexBinary",
						context.ItemDataHexBinary);

				parentContextMap_tRunJob_11.put("ItemDataHexFloat",
						context.ItemDataHexFloat);

				parentContextMap_tRunJob_11.put("ItemDataIncompleteDatetime",
						context.ItemDataIncompleteDatetime);

				parentContextMap_tRunJob_11.put("ItemDataInteger",
						context.ItemDataInteger);

				parentContextMap_tRunJob_11.put("ItemDataIntervalDatetime",
						context.ItemDataIntervalDatetime);

				parentContextMap_tRunJob_11.put("ItemDataPartialDate",
						context.ItemDataPartialDate);

				parentContextMap_tRunJob_11.put("ItemDataPartialDatetime",
						context.ItemDataPartialDatetime);

				parentContextMap_tRunJob_11.put("ItemDataPartialTime",
						context.ItemDataPartialTime);

				parentContextMap_tRunJob_11.put("ItemDataString",
						context.ItemDataString);

				parentContextMap_tRunJob_11.put("ItemDataTime",
						context.ItemDataTime);

				parentContextMap_tRunJob_11.put("ItemDataURI",
						context.ItemDataURI);
				...
				parentContextMap_tRunJob_11.put("xslt", context.xslt);

				parentContextMap_tRunJob_11.put("xslt_namespace",
						context.xslt_namespace);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ODM_MASTER.class.getClassLoader()
					.getResourceAsStream(
							"i2b2_postgres2/odm_master_0_1/contexts/"
...
/************************************************************************************************
 * 313185 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2015 3:56:19 PM CET
 ************************************************************************************************/
