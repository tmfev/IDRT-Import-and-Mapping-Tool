...
package i2b2_postgres2.idrt_truncate_tables_0_1;
...
public class IDRT_Truncate_Tables implements TalendJob {
	...
	public void tForeach_6_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		tForeach_6_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tForeach_6_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJava_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("TRUNCATE Transmart Postgres NYI");
	...
	public void tJava_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("TRUNCATE I2B2 Postgres!");
	...
	public void tForeach_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int NB_ITERATE_tJDBCRow_5 = 0; // for statistics
	...
	public void tForeach_6Process(final java.util.Map<String, Object> globalMap)
			throws TalendException {
		globalMap.put("tForeach_6_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				/**
				 * [tForeach_6 begin ] start
				 */

				int NB_ITERATE_tJDBCRow_6 = 0; // for statistics

				ok_Hash.put("tForeach_6", false);
				start_Hash.put("tForeach_6", System.currentTimeMillis());

				currentComponent = "tForeach_6";

				int tos_count_tForeach_6 = 0;

				Object[] values_tForeach_6 = new Object[] {
						"TRUNCATE TABLE " + context.DB_StagingI2B2_Schema
								+ ".QT_PATIENT_SET_COLLECTION",
						"TRUNCATE TABLE " + context.DB_StagingI2B2_Schema
								+ ".QT_PDO_QUERY_MASTER",
				...
				for (Object tmp_tForeach_6 : values_tForeach_6) {

					globalMap.put("tForeach_6_CURRENT_VALUE", tmp_tForeach_6);

					/**
					 * [tForeach_6 begin ] stop
					 */

					/**
					 * [tForeach_6 main ] start
					 */

					currentComponent = "tForeach_6";

					tos_count_tForeach_6++;

					/**
					 * [tForeach_6 main ] stop
					 */
					NB_ITERATE_tJDBCRow_6++;
					...
					query_tJDBCRow_6 = ((String) globalMap
							.get("tForeach_6_CURRENT_VALUE"));
				...
				ok_Hash.put("tForeach_6", true);
				end_Hash.put("tForeach_6", System.currentTimeMillis());
			...
			try {
				...
				/**
				 * [tForeach_6 finally ] start
				 */

				currentComponent = "tForeach_6";

				/**
				 * [tForeach_6 finally ] stop
				 */
		...
		globalMap.put("tForeach_6_SUBPROCESS_STATE", 1);
	}
		...
		try {
			...
			java.io.InputStream inContext = IDRT_Truncate_Tables.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/idrt_truncate_tables_0_1/contexts/"
...
/************************************************************************************************
 * 92923 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2015 3:56:15 PM CET
 ************************************************************************************************/
