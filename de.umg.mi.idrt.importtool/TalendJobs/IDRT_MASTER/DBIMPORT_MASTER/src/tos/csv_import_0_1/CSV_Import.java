	...
	public void tJDBCConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.lang.Class.forName(context.DB_StagingI2B2_sqlclassname);
...
/************************************************************************************************
 * 57630 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 4:22:31 PM CEST
 ************************************************************************************************/
