...
package i2b2_postgres2.pidgenerator_0_1;
...
public class PidGenerator implements TalendJob {
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_PidGenerator = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_PidGenerator = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_PidGenerator.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_PidGenerator.length == 0) {
						commonByteArray_I2B2_POSTGRES2_PidGenerator = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_PidGenerator = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_I2B2_POSTGRES2_PidGenerator, 0,
						length);
				strReturn = new String(
						commonByteArray_I2B2_POSTGRES2_PidGenerator, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_PidGenerator) {
							...
							if (field_tExtractDelimitedFields_1 != null) {// C_01
								...
								if (row3 != null) {
									...
									if (row3.status.endsWith("Failed")) {
										...
										StatusListener.errorInfo(
												"PIG-Gen Failed", "line/pid: "
														+ row3.own_pid + " "
														+ row1.Name + ", "
														+ row1.Vorname + " "
														+ row1.Geburtsdatum,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = PidGenerator.class.getClassLoader()
					.getResourceAsStream(
							"i2b2_postgres2/pidgenerator_0_1/contexts/"
...
/************************************************************************************************
 * 84716 characters generated by Talend Open Studio for Data Integration on the
 * March 11, 2015 1:16:44 PM CET
 ************************************************************************************************/
