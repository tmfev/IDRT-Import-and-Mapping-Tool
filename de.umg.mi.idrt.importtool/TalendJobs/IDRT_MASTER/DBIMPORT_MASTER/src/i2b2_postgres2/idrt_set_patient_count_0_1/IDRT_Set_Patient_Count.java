...
package i2b2_postgres2.idrt_set_patient_count_0_1;
...
/**
 * Job: IDRT_Set_Patient_Count Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class IDRT_Set_Patient_Count implements TalendJob {
	...
	private final String jobName = "IDRT_Set_Patient_Count";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					IDRT_Set_Patient_Count.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(IDRT_Set_Patient_Count.this, new Object[] {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("Setting Patient Count!");
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_IDRT_Set_Patient_Count = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_IDRT_Set_Patient_Count = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_IDRT_Set_Patient_Count) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Object[] values_tForeach_1 = new Object[] {
						"CREATE TABLE " + context.DB_StagingI2B2_Schema
						...
						"DROP TABLE " + context.DB_StagingI2B2_Schema
								+ ".t_totalnum",
						"DROP TABLE " + context.DB_StagingI2B2_Schema
								+ ".t_i2b2", };
	...
	public static void main(String[] args) {
		final IDRT_Set_Patient_Count IDRT_Set_Patient_CountClass = new IDRT_Set_Patient_Count();

		int exitCode = IDRT_Set_Patient_CountClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = IDRT_Set_Patient_Count.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/idrt_set_patient_count_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : IDRT_Set_Patient_Count");
		}
...
/************************************************************************************************
 * 46566 characters generated by Talend Open Studio for Data Integration on the
