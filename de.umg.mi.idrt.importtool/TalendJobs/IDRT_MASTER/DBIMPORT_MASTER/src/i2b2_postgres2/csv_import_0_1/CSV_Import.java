...
package i2b2_postgres2.csv_import_0_1;
...
public class CSV_Import implements TalendJob {
	...
	public void tJDBCConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String driverClass_tJDBCConnection_1 = context.DB_StagingI2B2_sqlclassname;
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_CSV_Import = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_CSV_Import = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_CSV_Import) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CSV_Import.class.getClassLoader()
					.getResourceAsStream(
							"i2b2_postgres2/csv_import_0_1/contexts/"
...
/************************************************************************************************
 * 59038 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2015 3:55:28 PM CET
 ************************************************************************************************/
