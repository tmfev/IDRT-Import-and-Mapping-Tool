...
package i2b2_postgres2.csv_master_0_1;
...
public class CSV_MASTER implements TalendJob {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT",
						"CONNECTION:SUBJOB_OK:tJava_4:OnSubjobOk1", "", Thread
								.currentThread().getId() + "", "", "", "", "",
						"");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT",
						"CONNECTION:SUBJOB_OK:tJava_4:OnSubjobOk2", "", Thread
								.currentThread().getId() + "", "", "", "", "",
						"");
			}
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.pidgenerator_0_1.PidGenerator childJob_tRunJob_9 = new i2b2_postgres2.pidgenerator_0_1.PidGenerator();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.idrt_truncate_tables_0_1.IDRT_Truncate_Tables childJob_tRunJob_6 = new i2b2_postgres2.idrt_truncate_tables_0_1.IDRT_Truncate_Tables();
				// pass DataSources
	...
	public static class row21Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_CSV_MASTER = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_CSV_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_CSV_MASTER.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_CSV_MASTER.length == 0) {
						commonByteArray_I2B2_POSTGRES2_CSV_MASTER = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_CSV_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_I2B2_POSTGRES2_CSV_MASTER, 0,
						length);
				strReturn = new String(
						commonByteArray_I2B2_POSTGRES2_CSV_MASTER, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_CSV_MASTER) {
				...
				try {
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (row21.value.toLowerCase().contains("utf")
								|| row21.value.toLowerCase().contains("uni")) {
	...
	public void tFileList_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final java.util.List<String> filePath_tFileList_6 = new java.util.ArrayList<String>();
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.csv_import_0_1.CSV_Import childJob_tRunJob_1 = new i2b2_postgres2.csv_import_0_1.CSV_Import();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.csv_patient_data_0_1.CSV_Patient_Data childJob_tRunJob_5 = new i2b2_postgres2.csv_patient_data_0_1.CSV_Patient_Data();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.idrt_to_db_schema_1_0.IDRT_to_DB_Schema childJob_tRunJob_3 = new i2b2_postgres2.idrt_to_db_schema_1_0.IDRT_to_DB_Schema();
				// pass DataSources
	...
	public void tFileList_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final java.util.List<String> filePath_tFileList_5 = new java.util.ArrayList<String>();
						...
						if (!file.isDirectory()) {
							...
							for (final java.util.regex.Pattern fileNamePattern_tFileList_5 : patternList_tFileList_5) {
								if (fileNamePattern_tFileList_5.matcher(
									...
									if (!filePath_tFileList_5.contains(file
											.getAbsolutePath())) {
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.idrt_jdbc_upload_1_0.IDRT_JDBC_Upload childJob_tRunJob_4 = new i2b2_postgres2.idrt_jdbc_upload_1_0.IDRT_JDBC_Upload();
				// pass DataSources
	...
	public void tDie_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("tDie_1_DIE_MESSAGE", "UPLOAD ERROR");
				globalMap.put("tDie_1_DIE_MESSAGES", "UPLOAD ERROR");
				currentComponent = "tDie_1";
				status = "failure";
	...
	public void tDie_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("tDie_2_DIE_MESSAGE", "CREATEDB ERROR");
				globalMap.put("tDie_2_DIE_MESSAGES", "CREATEDB ERROR");
				currentComponent = "tDie_2";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.idrt_set_patient_count_0_1.IDRT_Set_Patient_Count childJob_tRunJob_8 = new i2b2_postgres2.idrt_set_patient_count_0_1.IDRT_Set_Patient_Count();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_2.put("startDate", context.startDate);

				parentContextMap_tRunJob_2.put("OID", context.OID);

				parentContextMap_tRunJob_2.put("continueImport",
						context.continueImport);

				parentContextMap_tRunJob_2.put("currentConfig",
						context.currentConfig);

				parentContextMap_tRunJob_2.put("pidMap", context.pidMap);
				...
				i2b2_postgres2.database_stop_indexing_0_1.Database_Stop_Indexing childJob_tRunJob_2 = new i2b2_postgres2.database_stop_indexing_0_1.Database_Stop_Indexing();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_7.put("startDate", context.startDate);

				parentContextMap_tRunJob_7.put("OID", context.OID);

				parentContextMap_tRunJob_7.put("continueImport",
						context.continueImport);

				parentContextMap_tRunJob_7.put("currentConfig",
						context.currentConfig);

				parentContextMap_tRunJob_7.put("pidMap", context.pidMap);

				parentContextMap_tRunJob_7.put("importTerms",
						context.importTerms);

				parentContextMap_tRunJob_7.put("config", context.config);

				parentContextMap_tRunJob_7.put("currentFile",
						context.currentFile);

				parentContextMap_tRunJob_7.put("datePattern",
						context.datePattern);

				parentContextMap_tRunJob_7.put("fileName", context.fileName);

				parentContextMap_tRunJob_7.put("folderCSV", context.folderCSV);

				parentContextMap_tRunJob_7
						.put("folderMain", context.folderMain);

				parentContextMap_tRunJob_7.put("folderOutput",
						context.folderOutput);

				parentContextMap_tRunJob_7.put("output", context.output);

				parentContextMap_tRunJob_7.put("quoteChar", context.quoteChar);

				parentContextMap_tRunJob_7.put("cleanUp", context.cleanUp);

				parentContextMap_tRunJob_7.put("coding", context.coding);

				parentContextMap_tRunJob_7.put("dbImport", context.dbImport);

				parentContextMap_tRunJob_7.put("FTPPassword",
						context.FTPPassword);

				parentContextMap_tRunJob_7.put("FTPUser", context.FTPUser);

				parentContextMap_tRunJob_7.put("idFile", context.idFile);

				parentContextMap_tRunJob_7.put("IndexDrop", context.IndexDrop);

				parentContextMap_tRunJob_7.put("IndexStop", context.IndexStop);

				parentContextMap_tRunJob_7.put("pidgen", context.pidgen);

				parentContextMap_tRunJob_7.put("PIDURL", context.PIDURL);
				...
				parentContextMap_tRunJob_7.put("folderTmp", context.folderTmp);

				parentContextMap_tRunJob_7.put("i2b2HeadNode",
						context.i2b2HeadNode);

				parentContextMap_tRunJob_7.put("i2b2HeadNodeName",
						context.i2b2HeadNodeName);

				parentContextMap_tRunJob_7.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_7.put("MDPD", context.MDPD);

				parentContextMap_tRunJob_7.put("MDPDName", context.MDPDName);

				parentContextMap_tRunJob_7.put("counter", context.counter);

				parentContextMap_tRunJob_7.put("currentCounter",
						context.currentCounter);

				parentContextMap_tRunJob_7.put("status", context.status);

				parentContextMap_tRunJob_7.put("statusTmp", context.statusTmp);
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_11.put("startDate", context.startDate);

				parentContextMap_tRunJob_11.put("OID", context.OID);

				parentContextMap_tRunJob_11.put("continueImport",
						context.continueImport);

				parentContextMap_tRunJob_11.put("currentConfig",
						context.currentConfig);

				parentContextMap_tRunJob_11.put("pidMap", context.pidMap);

				parentContextMap_tRunJob_11.put("importTerms",
						context.importTerms);

				parentContextMap_tRunJob_11.put("config", context.config);

				parentContextMap_tRunJob_11.put("currentFile",
						context.currentFile);

				parentContextMap_tRunJob_11.put("datePattern",
						context.datePattern);

				parentContextMap_tRunJob_11.put("fileName", context.fileName);

				parentContextMap_tRunJob_11.put("folderCSV", context.folderCSV);

				parentContextMap_tRunJob_11.put("folderMain",
						context.folderMain);

				parentContextMap_tRunJob_11.put("folderOutput",
						context.folderOutput);

				parentContextMap_tRunJob_11.put("output", context.output);

				parentContextMap_tRunJob_11.put("quoteChar", context.quoteChar);

				parentContextMap_tRunJob_11.put("cleanUp", context.cleanUp);

				parentContextMap_tRunJob_11.put("coding", context.coding);

				parentContextMap_tRunJob_11.put("dbImport", context.dbImport);

				parentContextMap_tRunJob_11.put("FTPPassword",
						context.FTPPassword);

				parentContextMap_tRunJob_11.put("FTPUser", context.FTPUser);

				parentContextMap_tRunJob_11.put("idFile", context.idFile);

				parentContextMap_tRunJob_11.put("IndexDrop", context.IndexDrop);

				parentContextMap_tRunJob_11.put("IndexStop", context.IndexStop);

				parentContextMap_tRunJob_11.put("pidgen", context.pidgen);

				parentContextMap_tRunJob_11.put("PIDURL", context.PIDURL);

				parentContextMap_tRunJob_11.put("truncateProject",
						context.truncateProject);

				parentContextMap_tRunJob_11.put("truncateQueries",
						context.truncateQueries);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_DatabaseType",
						context.DB_StagingI2B2_DatabaseType);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_DriverClass",
						context.DB_StagingI2B2_DriverClass);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Host",
						context.DB_StagingI2B2_Host);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Instance",
						context.DB_StagingI2B2_Instance);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_jdbcurl",
						context.DB_StagingI2B2_jdbcurl);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Password",
						context.DB_StagingI2B2_Password);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Port",
						context.DB_StagingI2B2_Port);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Schema",
						context.DB_StagingI2B2_Schema);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_Username",
						context.DB_StagingI2B2_Username);

				parentContextMap_tRunJob_11.put("DB_StagingI2B2_WHType",
						context.DB_StagingI2B2_WHType);

				parentContextMap_tRunJob_11.put("folderTmp", context.folderTmp);

				parentContextMap_tRunJob_11.put("i2b2HeadNode",
						context.i2b2HeadNode);

				parentContextMap_tRunJob_11.put("i2b2HeadNodeName",
						context.i2b2HeadNodeName);

				parentContextMap_tRunJob_11.put("includePids",
						context.includePids);

				parentContextMap_tRunJob_11.put("MDPD", context.MDPD);

				parentContextMap_tRunJob_11.put("MDPDName", context.MDPDName);

				parentContextMap_tRunJob_11.put("counter", context.counter);

				parentContextMap_tRunJob_11.put("currentCounter",
						context.currentCounter);

				parentContextMap_tRunJob_11.put("status", context.status);

				parentContextMap_tRunJob_11.put("statusTmp", context.statusTmp);

				Object obj_tRunJob_11 = null;

				i2b2_postgres2.database_rebuild_indexing_0_1.Database_Rebuild_Indexing childJob_tRunJob_11 = new i2b2_postgres2.database_rebuild_indexing_0_1.Database_Rebuild_Indexing();
				// pass DataSources
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_12.put("startDate", context.startDate);

				parentContextMap_tRunJob_12.put("OID", context.OID);

				parentContextMap_tRunJob_12.put("continueImport",
						context.continueImport);

				parentContextMap_tRunJob_12.put("currentConfig",
						context.currentConfig);

				parentContextMap_tRunJob_12.put("pidMap", context.pidMap);

				parentContextMap_tRunJob_12.put("importTerms",
						context.importTerms);

				parentContextMap_tRunJob_12.put("config", context.config);
				...
				parentContextMap_tRunJob_12.put("folderCSV", context.folderCSV);
				...
				parentContextMap_tRunJob_12.put("output", context.output);

				parentContextMap_tRunJob_12.put("quoteChar", context.quoteChar);

				parentContextMap_tRunJob_12.put("cleanUp", context.cleanUp);

				parentContextMap_tRunJob_12.put("coding", context.coding);

				parentContextMap_tRunJob_12.put("dbImport", context.dbImport);
				...
				parentContextMap_tRunJob_12.put("idFile", context.idFile);

				parentContextMap_tRunJob_12.put("IndexDrop", context.IndexDrop);

				parentContextMap_tRunJob_12.put("IndexStop", context.IndexStop);

				parentContextMap_tRunJob_12.put("pidgen", context.pidgen);

				parentContextMap_tRunJob_12.put("PIDURL", context.PIDURL);
				...
				parentContextMap_tRunJob_12.put("DB_StagingI2B2_WHType",
						context.DB_StagingI2B2_WHType);
				...
				i2b2_postgres2.database_create_indexing_0_1.Database_Create_Indexing childJob_tRunJob_12 = new i2b2_postgres2.database_create_indexing_0_1.Database_Create_Indexing();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CSV_MASTER.class.getClassLoader()
					.getResourceAsStream(
							"i2b2_postgres2/csv_master_0_1/contexts/"
...
/************************************************************************************************
 * 259979 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2015 3:55:33 PM CET
 ************************************************************************************************/
