...
package i2b2_postgres2.dbimport_master_0_1;
...
public class DBIMPORT_MASTER implements TalendJob {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_DBIMPORT_MASTER = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER.length == 0) {
						commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER,
						0, length);
				strReturn = new String(
						commonByteArray_I2B2_POSTGRES2_DBIMPORT_MASTER, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_DBIMPORT_MASTER) {
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				i2b2_postgres2.csv_master_0_1.CSV_MASTER childJob_tRunJob_2 = new i2b2_postgres2.csv_master_0_1.CSV_MASTER();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = DBIMPORT_MASTER.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/dbimport_master_0_1/contexts/"
...
/************************************************************************************************
 * 93241 characters generated by Talend Open Studio for Data Integration on the
