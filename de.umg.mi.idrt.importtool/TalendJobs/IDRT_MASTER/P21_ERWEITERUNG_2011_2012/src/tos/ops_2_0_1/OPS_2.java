...
/**
 * Job: OPS_2 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class OPS_2 implements TalendJob {
	...
	private final String jobName = "OPS_2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(OPS_2.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_ops_2", new java.io.FileOutputStream(
	...
	public static class outStruct implements
		...
		final static byte[] commonByteArrayLock_TOS_OPS_2 = new byte[0];
		static byte[] commonByteArray_TOS_OPS_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_OPS_2.length) {
					if (length < 1024 && commonByteArray_TOS_OPS_2.length == 0) {
						commonByteArray_TOS_OPS_2 = new byte[1024];
					} else {
						commonByteArray_TOS_OPS_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_OPS_2, 0, length);
				strReturn = new String(commonByteArray_TOS_OPS_2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_OPS_2) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_ops_2"),
						"ISO-8859-15");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "OPS.csv", "UTF-8", ";",
								"\n", true, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row1.IK = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							row1.Entlassender_Standort = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							row1.Entgeltbereich = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row1.KH_internes_Kennzeichen = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 4;

							row1.OPS_Version = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row1.OPS_Kode = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row1.Lokalisation = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							row1.OPS_Datum = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 8;

							row1.Belegoperateur = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row1.Beleganaesthesist = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							row1.Beleghebamme = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'out'
									out_tmp.IK = row1.IK;
									out_tmp.ENTLASSENDER_STANDORT = row1.Entlassender_Standort;
									out_tmp.ENTGELTBEREICH = row1.Entgeltbereich;
									out_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_internes_Kennzeichen;
									out_tmp.OPS_VERSION = row1.OPS_Version;
									out_tmp.OPS_KODE = row1.OPS_Kode;
									out_tmp.LOKALISATION = row1.Lokalisation;
									out_tmp.OPS_DATUM = row1.OPS_Datum;
									out_tmp.BELEGOPERATEUR = row1.Belegoperateur;
									out_tmp.BELEGANAESTHESIST = row1.Beleganaesthesist;
									out_tmp.BELEGHEBAMME = row1.Beleghebamme;
									out_tmp.PATIENTENNR = row2.PATIENTENNUMMER;
									out = out_tmp;
							...
							if (out != null) {
								...
								if (out.ENTLASSENDER_STANDORT != null) {

									sb_tFileOutputDelimited_1.append(

									out.ENTLASSENDER_STANDORT
								...
								if (out.KH_INTERNES_KENNZEICHEN != null) {

									sb_tFileOutputDelimited_1.append(

									out.KH_INTERNES_KENNZEICHEN
								...
								if (out.BELEGANAESTHESIST != null) {

									sb_tFileOutputDelimited_1.append(

									out.BELEGANAESTHESIST
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row2.ENTLASSENDER_STANDORT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row2.ENTGELTBEREICH = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row2.KH_INTERNES_KENNZEICHEN = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row2.IK_DER_KRANKENKASSE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.GEBURTSMONAT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.AUFNAHMEGRUND = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.FALLZUSAMMENFHRUNGSGRUND = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 14;

							row2.AUFNAHMEGEWICHT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.ENTLASSUNGSGRUND = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 17;

							row2.ALTER_IN_TAGEN_AM_AUFNAHMETAG = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 18;

							row2.ALTER_IN_JAHREN_AM_AUFNAHMETAG = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 19;

							row2.PATIENTENNUMMER = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 20;

							row2.INTERKURRENTE_DIALYSEN = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 21;

							row2.BEATMUNGSSTUNDEN = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 22;

							row2.BEHANDLUNGSBEGINN_VORSTAT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 23;

							row2.BEHANDLUNGSTAGE_VORSTATIONAER = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 24;

							row2.BEHANDLUNGSENDE_NACHSTATIONAER = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 25;

							row2.BEHANDLUNGSTAGE_NACHSTATIONAER = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 26;

							row2.IK_VERLEGUNGS_KH = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.BEURLAUBUNGSTAGE_PSY = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
	...
	public static void main(String[] args) {
		final OPS_2 OPS_2Class = new OPS_2();

		int exitCode = OPS_2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = OPS_2.class.getClassLoader()
					.getResourceAsStream(
							"tos/ops_2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : OPS_2");
		}
...
/************************************************************************************************
 * 103753 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 4:23:49 PM CEST
 ************************************************************************************************/
