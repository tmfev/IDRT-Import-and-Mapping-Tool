...
/**
 * Job: FAB_2 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class FAB_2 implements TalendJob {
	...
	private final String jobName = "FAB_2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FAB_2.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_fab_2", new java.io.FileOutputStream(
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_FAB_2 = new byte[0];
		static byte[] commonByteArray_TOS_FAB_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_FAB_2.length) {
					if (length < 1024 && commonByteArray_TOS_FAB_2.length == 0) {
						commonByteArray_TOS_FAB_2 = new byte[1024];
					} else {
						commonByteArray_TOS_FAB_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_FAB_2, 0, length);
				strReturn = new String(commonByteArray_TOS_FAB_2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_FAB_2) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_fab_2"),
						"ISO-8859-15");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "FAB.csv", "UTF-8", ";",
								"\n", true, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row1.FAB = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row1.FAB_AUFNAHMEDATUM = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row1.FAB_ENTLASSUNGSDATUM = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'out1'
									out1_tmp.IK = row1.IK;
									out1_tmp.ENTLASSENDER_STANDORT = row1.ENTLASSENDER_STANDORT;
									out1_tmp.ENTGELTBEREICH = row1.ENTGELTBEREICH;
									out1_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_INTERNES_KENNZEICHEN;
									out1_tmp.FAB = row1.FAB;
									out1_tmp.FAB_AUFNAHMEDATUM = row1.FAB_AUFNAHMEDATUM;
									out1_tmp.FAB_ENTLASSUNGSDATUM = row1.FAB_ENTLASSUNGSDATUM;
							...
							if (out1 != null) {
								...
								if (out1.ENTLASSENDER_STANDORT != null) {

									sb_tFileOutputDelimited_1.append(

									out1.ENTLASSENDER_STANDORT
								...
								if (out1.FAB_AUFNAHMEDATUM != null) {

									sb_tFileOutputDelimited_1.append(

									out1.FAB_AUFNAHMEDATUM
								...
								if (out1.FAB_ENTLASSUNGSDATUM != null) {

									sb_tFileOutputDelimited_1.append(

									out1.FAB_ENTLASSUNGSDATUM
	...
	public static class row2Struct implements
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.GEBURTSJAHR = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.GEBURTSJAHR, dos, oos);
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row2.IK = fid_tFileInputDelimited_1
							...
							row2.GEBURTSJAHR = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row2.GESCHLECHT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row2.PLZ = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
	...
	public static void main(String[] args) {
		final FAB_2 FAB_2Class = new FAB_2();

		int exitCode = FAB_2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FAB_2.class.getClassLoader()
					.getResourceAsStream(
							"tos/fab_2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : FAB_2");
		}
...
/************************************************************************************************
 * 96303 characters generated by Talend Open Studio for Data Integration on the
