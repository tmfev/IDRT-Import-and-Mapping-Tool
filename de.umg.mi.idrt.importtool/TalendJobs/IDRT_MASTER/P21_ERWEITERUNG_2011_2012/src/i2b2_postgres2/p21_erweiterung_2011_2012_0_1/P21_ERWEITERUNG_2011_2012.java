...
package i2b2_postgres2.p21_erweiterung_2011_2012_0_1;
...
public class P21_ERWEITERUNG_2011_2012 implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012 = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012.length == 0) {
						commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012 = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012 = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_P21_ERWEITERUNG_2011_2012) {
		...
		try {
			...
			java.io.InputStream inContext = P21_ERWEITERUNG_2011_2012.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/p21_erweiterung_2011_2012_0_1/contexts/"
...
/************************************************************************************************
 * 83734 characters generated by Talend Open Studio for Data Integration on the
 * March 11, 2015 1:18:03 PM CET
 ************************************************************************************************/
