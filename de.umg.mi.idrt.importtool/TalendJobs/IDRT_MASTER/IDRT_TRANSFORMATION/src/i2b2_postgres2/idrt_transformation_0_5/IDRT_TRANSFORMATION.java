...
package i2b2_postgres2.idrt_transformation_0_5;
...
public class IDRT_TRANSFORMATION implements TalendJob {
	...
	public void tOracleConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tOracleConnection_1 = context.DBUsername;
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_IDRT_TRANSFORMATION = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION.length == 0) {
						commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_IDRT_TRANSFORMATION, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_IDRT_TRANSFORMATION) {
	...
	public void tOracleRow_16Process(
		...
		try {
			...
			try {
				...
				/**
				 * [tOracleRow_16 finally ] start
				 */

				currentComponent = "tOracleRow_16";

				/**
				 * [tOracleRow_16 finally ] stop
				 */
	...
	public void tOracleRow_17Process(
		...
		try {
			...
			try {
				...
				/**
				 * [tOracleRow_17 finally ] start
				 */

				currentComponent = "tOracleRow_17";

				/**
				 * [tOracleRow_17 finally ] stop
				 */
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tOracleRow_14 = "  CREATE TABLE  "
						+ context.DBSchema
						+ ".T_MAPPING\n   ( FACT_PATH VARCHAR2(500 CHAR), \n	 TERM_PATH VARCHAR2(500 CHAR), \n	 APPEND_LEVEL NUMBER, \n	 TRM_LEVEL NUMBER\n   )";
			...
			try {
				...
				/**
				 * [tOracleRow_14 finally ] start
				 */

				currentComponent = "tOracleRow_14";

				/**
				 * [tOracleRow_14 finally ] stop
				 */
			} catch (java.lang.Exception e) {
				// ignore
			} catch (java.lang.Error error) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final String decryptedPassword_tOracleOutput_1 = context.DBPassword;
				...
				if (rsTruncCount_tOracleOutput_1.next()) {
					rsTruncCountNumber_tOracleOutput_1 = rsTruncCount_tOracleOutput_1
							.getInt(1);
				}
	...
	public void tOracleRow_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.lang.Class.forName(driverClass_tOracleRow_5);

				String url_tOracleRow_5 = null;
				url_tOracleRow_5 = "jdbc:oracle:thin:@" + context.DBHost + ":"
						+ context.DBPort + ":" + context.DBInstance;
				String dbUser_tOracleRow_5 = context.DBUsername;

				final String decryptedPassword_tOracleRow_5 = context.DBPassword;
				...
				query_tOracleRow_5 = "INSERT INTO  "
						+ context.DBSchema
						+ ".TMP_I2B2 (\n SELECT \n  C_HLEVEL, \n  C_FULLNAME, \n  C_NAME, \n  C_SYNONYM_CD, \n  C_VISUALATTRIBUTES, \n  C_TOTALNUM, \n  C_BASECODE, \n  to_char(C_METADATAXML)  as C_METADATAXML, \n  C_FACTTABLECOLUMN, \n  C_TABLENAME, \n  C_COLUMNNAME, \n  C_COLUMNDATATYPE, \n  C_OPERATOR, \n  C_DIMCODE, \n  to_char(C_COMMENT) as C_COMMENT, \n  C_TOOLTIP, \n  M_APPLIED_PATH, \n  UPDATE_DATE, \n  DOWNLOAD_DATE, \n  IMPORT_DATE, \n  SOURCESYSTEM_CD, \n  VALUETYPE_CD, \n  M_EXCLUSION_CD, \n  C_PATH, \n  C_SYMBOL\nFROM  "
						+ context.DBSchema
						+ ".I2B2\nwhere C_HLEVEL < 4 and C_FULLNAME not like '\\i2b2\\ST%'\n\nUNION\n\nSELECT \n      trm.C_HLEVEL+tmp.APPEND_LEVEL as C_HLEVEL,\n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS c_fullname,\n      trm.c_name AS C_NAME,\n      fak.C_SYNONYM_CD, \n      trm.c_visualattributes as C_VISUALATTRIBUTES, \n      fak.C_TOTALNUM, \n      fak.c_basecode as C_BASECODE,\n      to_char(fak.C_METADATAXML)  as C_METADATAXML,  \n      fak.C_FACTTABLECOLUMN, \n      fak.C_TABLENAME, \n      fak.C_COLUMNNAME, \n      fak.C_COLUMNDATATYPE, \n      fak.C_OPERATOR, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_DIMCODE, \n      to_char(fak.C_COMMENT) as C_COMMENT, \n      trm.C_TOOLTIP, \n      fak.M_APPLIED_PATH, \n      fak.UPDATE_DATE, \n      fak.DOWNLOAD_DATE, \n      fak.IMPORT_DATE, \n      fak.SOURCESYSTEM_CD, \n      fak.VALUETYPE_CD, \n      fak.M_EXCLUSION_CD, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_PATH, \n      fak.C_SYMBOL  \n  FROM   "
						+ context.DBSchema
						+ ".i2b2      fak\n  JOIN  "
						+ context.DBSchema
						+ ".t_mapping tmp ON fak.c_fullname LIKE tmp.fact_path\n  JOIN   "
						+ context.DBSchema
						+ ".i2b2      trm ON trm.c_fullname LIKE tmp.term_path || '%'  \nWHERE trm.c_visualattributes NOT LIKE 'LA%' AND trm.C_HLEVEL >= tmp.TRM_LEVEL\n\nUNION\n\nSELECT\n      trm.C_HLEVEL+tmp.APPEND_LEVEL as C_HLEVEL,\n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS c_fullname,\n      trm.c_name AS C_NAME,  \n      fak.C_SYNONYM_CD, \n      trm.c_visualattributes as C_VISUALATTRIBUTES, \n      fak.C_TOTALNUM, \n      cnd.concept_cd as C_BASECODE,\n      to_char(fak.C_METADATAXML)  as C_METADATAXML,    \n      fak.C_FACTTABLECOLUMN, \n      fak.C_TABLENAME, \n      fak.C_COLUMNNAME, \n      fak.C_COLUMNDATATYPE, \n      fak.C_OPERATOR, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_DIMCODE, \n      to_char(fak.C_COMMENT) as C_COMMENT, \n      trm.C_TOOLTIP, \n      fak.M_APPLIED_PATH, \n      fak.UPDATE_DATE, \n      fak.DOWNLOAD_DATE, \n      fak.IMPORT_DATE, \n      fak.SOURCESYSTEM_CD, \n      fak.VALUETYPE_CD, \n      fak.M_EXCLUSION_CD, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_PATH, \n      fak.C_SYMBOL \n  FROM   "
						+ context.DBSchema
						+ ".i2b2      fak\n  JOIN   "
						+ context.DBSchema
						+ ".t_mapping tmp ON fak.c_fullname LIKE tmp.fact_path || '%'\n  JOIN   "
						...
						+ ".i2b2      trm ON trm.c_fullname LIKE tmp.term_path || '%'  \n  JOIN   "
						+ context.DBSchema
						+ ".concept_dimension cnd ON fak.c_fullname = cnd.concept_path\nWHERE fak.c_name = SUBSTR(trm.c_basecode,INSTR(trm.c_basecode,':')+1)  \nAND trm.c_visualattributes LIKE 'LA%' AND fak.c_visualattributes LIKE 'LA%'\n\nUNION\n\nSELECT\n      trm.C_HLEVEL+tmp.APPEND_LEVEL as C_HLEVEL,\n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS c_fullname,\n      trm.c_name AS C_NAME,  \n      fak.C_SYNONYM_CD, \n      trm.c_visualattributes as C_VISUALATTRIBUTES, \n      fak.C_TOTALNUM, \n      cnd.concept_cd as C_BASECODE,\n      to_char(fak.C_METADATAXML)  as C_METADATAXML,    \n      fak.C_FACTTABLECOLUMN, \n      fak.C_TABLENAME, \n      fak.C_COLUMNNAME, \n      fak.C_COLUMNDATATYPE, \n      fak.C_OPERATOR, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_DIMCODE, \n      to_char(fak.C_COMMENT) as C_COMMENT, \n      trm.C_TOOLTIP, \n      fak.M_APPLIED_PATH, \n      fak.UPDATE_DATE, \n      fak.DOWNLOAD_DATE, \n      fak.IMPORT_DATE, \n      fak.SOURCESYSTEM_CD, \n      fak.VALUETYPE_CD, \n      fak.M_EXCLUSION_CD, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_PATH, \n      fak.C_SYMBOL \n  FROM   "
						+ context.DBSchema
						+ ".i2b2      fak\n  JOIN   "
						+ context.DBSchema
						+ ".t_mapping tmp ON fak.c_fullname LIKE tmp.fact_path || '%'\n  JOIN   "
						...
						+ ".i2b2      trm ON trm.c_fullname LIKE tmp.term_path || '%'  \n  JOIN   "
						+ context.DBSchema
						+ ".concept_dimension cnd ON fak.c_fullname = cnd.concept_path\nWHERE  fak.c_name = replace(replace(SUBSTR(trm.c_basecode,INSTR(trm.c_basecode,':')+1),'-',''),'.','') \nAND trm.c_visualattributes LIKE 'LA%' AND fak.c_visualattributes LIKE 'LA%' AND tmp.fact_path LIKE '\\i2b2\\PD\\OPS\\OPS_KODE\\%'\n\nUNION\n\nSELECT\n      trm.C_HLEVEL+tmp.APPEND_LEVEL as C_HLEVEL,\n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS c_fullname,\n      trm.c_name AS C_NAME,  \n      fak.C_SYNONYM_CD, \n      trm.c_visualattributes as C_VISUALATTRIBUTES, \n      fak.C_TOTALNUM, \n      cnd.concept_cd as C_BASECODE,\n       to_char(fak.C_METADATAXML)  as C_METADATAXML,   \n      fak.C_FACTTABLECOLUMN, \n      fak.C_TABLENAME, \n      fak.C_COLUMNNAME, \n      fak.C_COLUMNDATATYPE, \n      fak.C_OPERATOR, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_DIMCODE, \n      to_char(fak.C_COMMENT) as C_COMMENT, \n      trm.C_TOOLTIP, \n      fak.M_APPLIED_PATH, \n      fak.UPDATE_DATE, \n      fak.DOWNLOAD_DATE, \n      fak.IMPORT_DATE, \n      fak.SOURCESYSTEM_CD, \n      fak.VALUETYPE_CD, \n      fak.M_EXCLUSION_CD, \n      SUBSTR(fak.c_fullname, 1, LENGTH(tmp.fact_path)) || SUBSTR(trm.c_fullname,\n      LENGTH(tmp.term_path)+1) AS C_PATH, \n      fak.C_SYMBOL \n  FROM   "
						+ context.DBSchema
						+ ".i2b2      fak\n  JOIN   "
						+ context.DBSchema
						+ ".t_mapping tmp ON fak.c_fullname LIKE tmp.fact_path || '%'\n  JOIN   "
						...
						+ ".i2b2      trm ON trm.c_fullname LIKE tmp.term_path || '%'  \n  JOIN   "
						+ context.DBSchema
						+ ".concept_dimension cnd ON fak.c_fullname = cnd.concept_path\nWHERE  SUBSTR(fak.c_name,INSTR(fak.c_name,':')+3) = SUBSTR(trm.c_basecode,INSTR(trm.c_basecode,':')+1)  \nAND trm.c_visualattributes LIKE 'LA%' AND fak.c_visualattributes LIKE 'LA%'\nAND tmp.fact_path LIKE '\\i2b2\\PD\\FAB\\FAB\\%'\n\nUNION\n\n\nSELECT\n  fak.C_HLEVEL, \n  fak.C_FULLNAME, \n  fak.C_NAME, \n  fak.C_SYNONYM_CD, \n  fak.C_VISUALATTRIBUTES, \n  fak.C_TOTALNUM, \n  fak.C_BASECODE, \n  to_char(fak.C_METADATAXML)  as C_METADATAXML,    \n  fak.C_FACTTABLECOLUMN, \n  fak.C_TABLENAME, \n  fak.C_COLUMNNAME, \n  fak.C_COLUMNDATATYPE, \n  fak.C_OPERATOR, \n  fak.C_DIMCODE, \n  to_char(fak.C_COMMENT) as C_COMMENT, \n  fak.C_TOOLTIP, \n  fak.M_APPLIED_PATH, \n  fak.UPDATE_DATE, \n  fak.DOWNLOAD_DATE, \n  fak.IMPORT_DATE, \n  fak.SOURCESYSTEM_CD, \n  fak.VALUETYPE_CD, \n  fak.M_EXCLUSION_CD, \n  fak.C_PATH, \n  fak.C_SYMBOL\n  FROM   "
						+ context.DBSchema
						+ ".i2b2  fak\n  where fak.c_hlevel > 3 and fak.c_fullname not like '\\i2b2\\ST%' AND fak.c_visualattributes NOT LIKE 'LA%'\n  and fak.c_fullname not in\n    (SELECT  fak2.C_FULLNAME \n     FROM   "
						+ context.DBSchema
						+ ".i2b2      fak2\n     JOIN   "
						+ context.DBSchema
						...
						+ ".i2b2  fak\n  JOIN   "
						+ context.DBSchema
						+ ".concept_dimension cnd ON fak.c_fullname = cnd.concept_path\n  where fak.c_hlevel > 3 and fak.c_fullname not like '\\i2b2\\ST%' AND fak.c_visualattributes LIKE 'LA%'\n  and fak.c_fullname not in\n    (SELECT  fak2.C_FULLNAME \n     FROM   "
						+ context.DBSchema
						+ ".i2b2      fak2\n     JOIN   "
						+ context.DBSchema
						+ ".t_mapping tmp2 ON fak2.c_fullname LIKE tmp2.fact_path || '%')\n)\n";
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tOracleRow_12 = "INSERT INTO  "
						+ context.DBSchema
						+ ".CONCEPT_DIMENSION (CONCEPT_CD, CONCEPT_PATH, NAME_CHAR, CONCEPT_BLOB, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, UPLOAD_ID)\n SELECT DISTINCT C_BASECODE, C_FULLNAME, C_NAME, null, null, null, null, null, null FROM   "
						+ context.DBSchema
						+ ".I2B2 \nWHERE C_VISUALATTRIBUTES LIKE 'LA%'";
			...
			try {
				...
				/**
				 * [tOracleRow_12 finally ] start
				 */

				currentComponent = "tOracleRow_12";

				/**
				 * [tOracleRow_12 finally ] stop
				 */
			} catch (java.lang.Exception e) {
				// ignore
			} catch (java.lang.Error error) {
	...
	public void tOracleRow_15Process(
		...
		try {
			...
			try {
				...
				/**
				 * [tOracleRow_15 finally ] start
				 */

				currentComponent = "tOracleRow_15";

				/**
				 * [tOracleRow_15 finally ] stop
				 */
			} catch (java.lang.Exception e) {
				// ignore
			} catch (java.lang.Error error) {
		...
		try {
			...
			java.io.InputStream inContext = IDRT_TRANSFORMATION.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/idrt_transformation_0_5/contexts/"
...
/************************************************************************************************
 * 160739 characters generated by Talend Open Studio for Data Integration on the
 * March 11, 2015 1:17:22 PM CET
 ************************************************************************************************/
