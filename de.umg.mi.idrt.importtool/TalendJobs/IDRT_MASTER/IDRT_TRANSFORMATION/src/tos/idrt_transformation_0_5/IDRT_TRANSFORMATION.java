	...
	public void tOracleConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String password_tOracleConnection_1 = decryptedPassword_tOracleConnection_1;
				...
				if (resourceMap.get("finish_tOracleOutput_1") == null) {
					if (resourceMap.get("conn_tOracleOutput_1") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tOracleOutput_1 :"
											+ sqlEx_tOracleOutput_1
													.getMessage());
						}
					}
				}
	...
	public void tOracleRow_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url_tOracleRow_5 = "jdbc:oracle:thin:@" + context.DBHost
						+ ":" + context.DBPort + ":" + context.DBInstance;
...
/************************************************************************************************
 * 159374 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 4:23:06 PM CEST
 ************************************************************************************************/
