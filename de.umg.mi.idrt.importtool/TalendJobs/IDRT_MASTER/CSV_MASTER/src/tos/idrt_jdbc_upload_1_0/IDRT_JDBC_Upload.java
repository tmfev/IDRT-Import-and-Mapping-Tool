	...
	public void tFileInputDelimited_9Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_1 = 50000;
				int commitCounter_tJDBCOutput_1 = 0;
				int batchSize_tJDBCOutput_1 = 2000;
				...
				try {
					...
					while (limittFileInputDelimited_9 != 0
						...
						if (row10 != null) {
							...
							row23.PATIENT_NUM = row10.PATIENT_NUM;// .add(new
																	// BigDecimal(10000));
							row23.CONCEPT_CD = row10.CONCEPT_CD.toLowerCase();
							row23.PROVIDER_ID = row10.PROVIDER_ID;
							row23.START_DATE = row10.START_DATE;
							row23.MODIFIER_CD = row10.MODIFIER_CD.toLowerCase();
							...
							if (row25 != null) {
								...
								if (row25.END_DATE != null) {
									pstmt_tJDBCOutput_1.setTimestamp(14,
											new java.sql.Timestamp(
													row25.END_DATE.getTime()));
								} else {
				...
				if (resourceMap.get("finish_tJDBCOutput_1") == null) {
					if (resourceMap.get("conn_tJDBCOutput_1") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_1 :"
	...
	public void tDie_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_1_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_1_ERROR_MESSAGE")));
				globalMap
						.put("tDie_1_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_1_ERROR_MESSAGE")));
				currentComponent = "tDie_1";
				status = "failure";
	...
	public void tFileInputDelimited_10Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int updateKeyCount_tJDBCOutput_15 = 1;
				if (updateKeyCount_tJDBCOutput_15 < 1) {
				...
				int commitEvery_tJDBCOutput_15 = 100000;
				...
				java.sql.PreparedStatement pstmtInsert_tJDBCOutput_15 = connection_tJDBCOutput_15
						.prepareStatement(insert_tJDBCOutput_15);
				String update_tJDBCOutput_15 = "UPDATE "
						+ context.currentTable
				...
				java.sql.PreparedStatement pstmtUpdate_tJDBCOutput_15 = connection_tJDBCOutput_15
						.prepareStatement(update_tJDBCOutput_15);
							...
							if (outt != null) {
								...
								if (row24 != null) {
									...
									if (row24.C_FULLNAME == null) {
										...
										pstmt_tJDBCOutput_15.setString(1,
												row24.C_FULLNAME);
									}

									java.sql.ResultSet rs_tJDBCOutput_15 = pstmt_tJDBCOutput_15
											.executeQuery();
									int checkCount_tJDBCOutput_15 = -1;
									while (rs_tJDBCOutput_15.next()) {
										checkCount_tJDBCOutput_15 = rs_tJDBCOutput_15
												.getInt(1);
									}
									if (checkCount_tJDBCOutput_15 > 0) {
										pstmtUpdate_tJDBCOutput_15.setInt(1,
												row24.C_HLEVEL);

										if (row24.C_NAME == null) {
											pstmtUpdate_tJDBCOutput_15.setNull(
													2, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tJDBCOutput_15
										...
										try {
											updatedCount_tJDBCOutput_15 = updatedCount_tJDBCOutput_15
													+ pstmtUpdate_tJDBCOutput_15
															.executeUpdate();
										} catch (java.lang.Exception e) {
										...
										pstmtInsert_tJDBCOutput_15.setInt(1,
												row24.C_HLEVEL);

										if (row24.C_FULLNAME == null) {
											pstmtInsert_tJDBCOutput_15.setNull(
													2, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tJDBCOutput_15
													.setString(2,
															row24.C_FULLNAME);
										}
				...
				if (pstmtUpdate_tJDBCOutput_15 != null) {

					pstmtUpdate_tJDBCOutput_15.close();

				}
				if (pstmtInsert_tJDBCOutput_15 != null) {

					pstmtInsert_tJDBCOutput_15.close();
				...
				if (resourceMap.get("finish_tJDBCOutput_15") == null) {
					if (resourceMap.get("conn_tJDBCOutput_15") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_15 :"
	...
	public void tDie_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.err.println(((String) globalMap
						.get("tJDBCOutput_15_ERROR_MESSAGE")));
				globalMap
						.put("tDie_2_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_15_ERROR_MESSAGE")));
				globalMap
						.put("tDie_2_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_15_ERROR_MESSAGE")));
				currentComponent = "tDie_2";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_12Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_2 = 100000;
					...
					while (limittFileInputDelimited_12 != 0
						...
						if (row13 != null) {
							...
							if (row21 != null) {
								...
								pstmt_tJDBCOutput_2.setBigDecimal(3,
										row21.ENCOUNTER_NUM);
				...
				if (resourceMap.get("finish_tJDBCOutput_2") == null) {
					if (resourceMap.get("conn_tJDBCOutput_2") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_2 :"
	...
	public void tDie_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_3_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_2_ERROR_MESSAGE")));
				globalMap
						.put("tDie_3_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_2_ERROR_MESSAGE")));
				currentComponent = "tDie_3";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_3 = 100000;
				...
				try {
					...
					while (limittFileInputDelimited_6 != 0
						...
						if (row6 != null) {
							...
							row1.PATIENT_NUM = row6.PATIENT_NUM;// .add(new
																// BigDecimal(10000));
							...
							if (row1.UPLOAD_DATE != null) {
								pstmt_tJDBCOutput_3.setTimestamp(
										5,
										new java.sql.Timestamp(row1.UPLOAD_DATE
												.getTime()));
							} else {
							...
							if (row1.DOWNLOAD_DATE != null) {
								pstmt_tJDBCOutput_3.setTimestamp(7,
										new java.sql.Timestamp(
												row1.DOWNLOAD_DATE.getTime()));
							} else {
							...
							if (row1.IMPORT_DATE != null) {
								pstmt_tJDBCOutput_3.setTimestamp(
										8,
										new java.sql.Timestamp(row1.IMPORT_DATE
												.getTime()));
							} else {
							...
							if (row1.UPLOAD_ID == null) {
								...
								pstmt_tJDBCOutput_3.setInt(10, row1.UPLOAD_ID);
							}
				...
				if (resourceMap.get("finish_tJDBCOutput_3") == null) {
					if (resourceMap.get("conn_tJDBCOutput_3") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_3 :"
	...
	public void tDie_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_4_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_3_ERROR_MESSAGE")));
				globalMap
						.put("tDie_4_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_3_ERROR_MESSAGE")));
				currentComponent = "tDie_4";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_7Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_9 = 100000;
				...
				if (resourceMap.get("finish_tJDBCOutput_9") == null) {
					if (resourceMap.get("conn_tJDBCOutput_9") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_9 :"
				...
				if (resourceMap.get("finish_tJDBCOutput_4") == null) {
					if (resourceMap.get("conn_tJDBCOutput_4") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_4 :"
	...
	public void tDie_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.err.println(((String) globalMap
						.get("tJDBCOutput_9_ERROR_MESSAGE")));
				globalMap
						.put("tDie_5_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_9_ERROR_MESSAGE")));
				globalMap
						.put("tDie_5_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_9_ERROR_MESSAGE")));
				currentComponent = "tDie_5";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_8Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_5 = 100000;
					...
					while (limittFileInputDelimited_8 != 0
						...
						if (row8 != null) {
							...
							if (row19 != null) {
								...
								// Code generated according to input schema and
								// output schema
								row26.CONCEPT_PATH = row19.CONCEPT_PATH
										.toLowerCase();
								row26.CONCEPT_CD = row19.CONCEPT_CD
										.toLowerCase();
								row26.NAME_CHAR = row19.NAME_CHAR;
								row26.CONCEPT_BLOB = row19.CONCEPT_BLOB;
								row26.UPDATE_DATE = row19.UPDATE_DATE;
								row26.DOWNLOAD_DATE = row19.DOWNLOAD_DATE;
								row26.IMPORT_DATE = row19.IMPORT_DATE;
								row26.SOURCESYSTEM_CD = row19.SOURCESYSTEM_CD;
								row26.UPLOAD_ID = row19.UPLOAD_ID;
				...
				if (resourceMap.get("finish_tJDBCOutput_5") == null) {
					if (resourceMap.get("conn_tJDBCOutput_5") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_5 :"
	...
	public void tDie_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_6_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_5_ERROR_MESSAGE")));
				globalMap
						.put("tDie_6_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_5_ERROR_MESSAGE")));
				currentComponent = "tDie_6";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_14Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_6 = 100000;
					...
					while (limittFileInputDelimited_14 != 0
						...
						if (row17 != null) {
							...
							if (row20 != null) {
								...
								// Code generated according to input schema and
								// output schema
								row28.MODIFIER_PATH = row20.MODIFIER_PATH
										.toLowerCase();
								row28.MODIFIER_CD = row20.MODIFIER_CD
										.toLowerCase();
								row28.NAME_CHAR = row20.NAME_CHAR;
								row28.MODIFIER_BLOB = row20.MODIFIER_BLOB;
								row28.UPDATE_DATE = row20.UPDATE_DATE;
								row28.DOWNLOAD_DATE = row20.DOWNLOAD_DATE;
								row28.IMPORT_DATE = row20.IMPORT_DATE;
								row28.SOURCESYSTEM_CD = row20.SOURCESYSTEM_CD;
								row28.UPLOAD_ID = row20.UPLOAD_ID;
								...
								if (row28.SOURCESYSTEM_CD == null) {
									pstmt_tJDBCOutput_6.setNull(8,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tJDBCOutput_6.setString(8,
											row28.SOURCESYSTEM_CD);
								}

								if (row28.UPLOAD_ID == null) {
				...
				if (resourceMap.get("finish_tJDBCOutput_6") == null) {
					if (resourceMap.get("conn_tJDBCOutput_6") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_6 :"
	...
	public void tDie_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_7_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_6_ERROR_MESSAGE")));
				globalMap
						.put("tDie_7_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_6_ERROR_MESSAGE")));
				currentComponent = "tDie_7";
				status = "failure";
				errorCode = new Integer(1);
	...
	public void tFileInputDelimited_16Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int commitEvery_tJDBCOutput_7 = 100000;
				...
				try {
					...
					while (limittFileInputDelimited_16 != 0
						...
						if (row18 != null) {
							...
							row2.PATIENT_NUM = row18.PATIENT_NUM;// .add(new
																	// BigDecimal(10000));
							...
							if (row2.START_DATE != null) {
								pstmt_tJDBCOutput_7.setTimestamp(
										4,
										new java.sql.Timestamp(row2.START_DATE
												.getTime()));
							} else {
							...
							if (row2.END_DATE != null) {
								pstmt_tJDBCOutput_7.setTimestamp(
										5,
										new java.sql.Timestamp(row2.END_DATE
												.getTime()));
							} else {
							...
							if (row2.INOUT_CD == null) {
								...
								pstmt_tJDBCOutput_7.setString(6, row2.INOUT_CD);
							}
							...
							if (row2.UPDATE_DATE != null) {
								pstmt_tJDBCOutput_7.setTimestamp(
										11,
										new java.sql.Timestamp(row2.UPDATE_DATE
												.getTime()));
							} else {
							...
							if (row2.DOWNLOAD_DATE != null) {
								pstmt_tJDBCOutput_7.setTimestamp(12,
										new java.sql.Timestamp(
												row2.DOWNLOAD_DATE.getTime()));
							} else {
							...
							if (row2.IMPORT_DATE != null) {
								pstmt_tJDBCOutput_7.setTimestamp(
										13,
										new java.sql.Timestamp(row2.IMPORT_DATE
												.getTime()));
							} else {
							...
							if (row2.UPLOAD_ID == null) {
								...
								pstmt_tJDBCOutput_7.setInt(15, row2.UPLOAD_ID);
							}
				...
				if (resourceMap.get("finish_tJDBCOutput_7") == null) {
					if (resourceMap.get("conn_tJDBCOutput_7") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_7 :"
	...
	public void tDie_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap
						.put("tDie_8_DIE_MESSAGE", ((String) globalMap
								.get("tJDBCOutput_7_ERROR_MESSAGE")));
				globalMap
						.put("tDie_8_DIE_MESSAGES", ((String) globalMap
								.get("tJDBCOutput_7_ERROR_MESSAGE")));
				currentComponent = "tDie_8";
				status = "failure";
				errorCode = new Integer(1);
				...
				if (resourceMap.get("finish_tJDBCOutput_8") == null) {
					if (resourceMap.get("conn_tJDBCOutput_8") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_8 :"
				...
				if (resourceMap.get("finish_tJDBCOutput_13") == null) {
					if (resourceMap.get("conn_tJDBCOutput_13") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_13 :"
				...
				if (resourceMap.get("finish_tJDBCOutput_12") == null) {
					if (resourceMap.get("conn_tJDBCOutput_12") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_12 :"
				...
				if (resourceMap.get("finish_tJDBCOutput_17") == null) {
					if (resourceMap.get("conn_tJDBCOutput_17") != null) {
						try {
							...
							System.out
									.println("failed to close the connection in tJDBCOutput_17 :"
...
/************************************************************************************************
 * 849953 characters generated by Talend Open Studio for Data Integration on the
