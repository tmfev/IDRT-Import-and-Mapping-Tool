...
public class PidGenerator implements TalendJob {
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_PidGenerator = new byte[0];
		static byte[] commonByteArray_TOS_PidGenerator = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_PidGenerator.length) {
					if (length < 1024
							&& commonByteArray_TOS_PidGenerator.length == 0) {
						commonByteArray_TOS_PidGenerator = new byte[1024];
					} else {
						commonByteArray_TOS_PidGenerator = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_PidGenerator, 0, length);
				strReturn = new String(commonByteArray_TOS_PidGenerator, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_PidGenerator) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = PidGenerator.class.getClassLoader()
					.getResourceAsStream(
							"tos/pidgenerator_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 84385 characters generated by Talend Open Studio for Data Integration on the
