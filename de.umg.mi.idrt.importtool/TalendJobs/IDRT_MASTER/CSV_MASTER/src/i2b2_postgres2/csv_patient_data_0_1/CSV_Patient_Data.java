...
package i2b2_postgres2.csv_patient_data_0_1;
...
public class CSV_Patient_Data implements TalendJob {
	...
	public void tUniqRow_3_UniqOut_error(java.lang.Exception exception,
		...
		tUniqRow_3_UniqIn_error(exception, errorComponent, globalMap);
	...
	public static class row15Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_CSV_Patient_Data = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data.length == 0) {
						commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data,
						0, length);
				strReturn = new String(
						commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_CSV_Patient_Data) {
	...
	public static class to_ont_blobStruct implements
			routines.system.IPersistableRow<to_ont_blobStruct> {
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_CSV_Patient_Data = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_CSV_Patient_Data = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(to_ont_blobStruct other) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				to_ont_blobStruct to_ont_blob = new to_ont_blobStruct();
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					headColutFileOutputDelimited_1[21] = "Blob";
				...
				to_ont_blobStruct to_ont_blob_tmp = new to_ont_blobStruct();
				// ###############################
					...
					while (limittFileInputDelimited_1 != 0
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									fromOutput.Blob = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if (fromOutput != null) {
							...
							if (!rejectedInnerJoin_tMap_4) { // G_TM_M_020
								...
								fromOntHashKey.PathID = fromOutput.Item;

								fromOntHashKey.hashCodeDirty = true;

								tHash_Lookup_fromOnt.lookup(fromOntHashKey);
							...
							if (tHash_Lookup_fromOnt != null
									&& tHash_Lookup_fromOnt.hasNext()) { // G
																			// 099
							...
							if (asd != null) {
								...
								// 16.02.2015
								if (asd.Blob.length() > 0) {
									String hash = asd.Path;
									// TODO: hier womoeglich Problem mit Pfad?!
									fromPatient.Path = asd.Path
											+ hash.hashCode() + "_blob\\";
									fromPatient.mod_item = "blob";
								} else if (asd.DataType.toLowerCase().trim()
										.equals("string")) {
									String hash = asd.Path + asd.Value;
									fromPatient.Path = asd.Path
											+ hash.hashCode() + "\\";
									if (asd.Value.length() < 20) {
										fromPatient.Path = asd.Path + asd.Value
												+ "\\";
									}

								} else if (asd.DataType.toLowerCase().trim()
										.equals("float")) {
									fromPatient.Path = asd.Path + asd.Item
											+ "_xml\\";
								...
								if (asd.DataType.toLowerCase().trim()
										.equals("date")
										|| asd.DataType.toLowerCase().trim()
												.equals("partialDate")) {
									Date date2 = TalendDate.parseDate(
											context.datePattern, asd.Value);
									fromPatient.StartDate = date2;
								} else
								...
								if (asd.m_applied_path == null) {
									fromPatient.m_applied_path = "@";
									// System.out.println("NULL " + asd.Value);
								} else
								...
								{ // start of Var scope
									...
									Var.var2 = fromPatient.DataType
											.toLowerCase().equals("integer");
									Var.isBlob = fromPatient.Blob.length() > 0;// ###############################
									// ###############################
									// # Output tables
									...
									toData_tmp.Blob = fromPatient.Blob;
									toData = toData_tmp;
									...
									!(Var.var2 || Var.var1 || Var.var3 || Var.isBlob)
									...
									Var.isBlob
										...
										to_ont_blob_tmp.HLEVEL = fromPatient.m_applied_path
												.equals("@") ? 4 : 2;
										to_ont_blob_tmp.Name = fromPatient.Item
												+ " (Blob)";
										to_ont_blob_tmp.Path = fromPatient.Path;
										to_ont_blob_tmp.DataType = fromPatient.DataType;
										to_ont_blob_tmp.Update_Date = fromPatient.UpdateDate;
										to_ont_blob_tmp.Import_Date = fromPatient.ImportDate;
										to_ont_blob_tmp.Download_Date = fromPatient.DownloadDate;
										to_ont_blob_tmp.PathID = fromPatient.PathID;
										to_ont_blob_tmp.visual = fromPatient.m_applied_path
												.equals("@") ? "LA" : "RA";
										to_ont_blob_tmp.codeList = "";
										to_ont_blob_tmp.source = "";
										to_ont_blob_tmp.xml = "blob";
										to_ont_blob_tmp.m_applied_path = fromPatient.m_applied_path;
										to_ont_blob = to_ont_blob_tmp;
									} // closing filter/reject
										// ###############################
								...
								if (toData != null) {
									...
									rowtFileOutputDelimited_1[21] = toData.Blob == null ? ""
											: toData.Blob;
								...
								} // End of branch "to_ont_xml"

								// Start of branch "to_ont_date"
								if (to_ont_date != null) {
								...
								} // End of branch "to_ont_date"

								// Start of branch "to_ont_blob"
								if (to_ont_blob != null) {
									...
									// and output schema
									context.ontOutputRows++;
									row15.HLEVEL = to_ont_blob.HLEVEL;
									row15.Name = to_ont_blob.Name;
									row15.Path = to_ont_blob.Path;
									row15.DataType = to_ont_blob.DataType;
									row15.Update_Date = to_ont_blob.Update_Date;
									row15.Import_Date = to_ont_blob.Import_Date;
									row15.Download_Date = to_ont_blob.Download_Date;
									row15.PathID = to_ont_blob.PathID;
									row15.visual = to_ont_blob.visual;
									row15.codeList = to_ont_blob.codeList;
									row15.source = to_ont_blob.source;
									row15.xml = to_ont_blob.xml;
									row15.m_applied_path = to_ont_blob.m_applied_path;
									...
									rowtFileOutputDelimited_4[0] = row15.HLEVEL == null ? ""
											: String.valueOf(row15.HLEVEL);

									rowtFileOutputDelimited_4[1] = row15.Name == null ? ""
											: row15.Name;

									rowtFileOutputDelimited_4[2] = row15.Path == null ? ""
											: row15.Path;

									rowtFileOutputDelimited_4[3] = row15.DataType == null ? ""
											: row15.DataType;

									rowtFileOutputDelimited_4[4] = row15.Update_Date == null ? ""
											: FormatterUtils.format_Date(
													row15.Update_Date,
													"dd-MM-yyyy");

									rowtFileOutputDelimited_4[5] = row15.Import_Date == null ? ""
											: FormatterUtils.format_Date(
													row15.Import_Date,
													"dd-MM-yyyy");

									rowtFileOutputDelimited_4[6] = row15.Download_Date == null ? ""
											: FormatterUtils.format_Date(
													row15.Download_Date,
													"dd-MM-yyyy");

									rowtFileOutputDelimited_4[7] = row15.PathID == null ? ""
											: row15.PathID;

									rowtFileOutputDelimited_4[8] = row15.visual == null ? ""
											: row15.visual;

									rowtFileOutputDelimited_4[9] = row15.codeList == null ? ""
											: row15.codeList;

									rowtFileOutputDelimited_4[10] = row15.source == null ? ""
											: row15.source;

									rowtFileOutputDelimited_4[11] = row15.xml == null ? ""
											: row15.xml;

									rowtFileOutputDelimited_4[12] = row15.m_applied_path == null ? ""
											: row15.m_applied_path;
									...
									if (nb_line_tFileOutputDelimited_4 % 50000 == 0) {
	...
	public void tFileInputDelimited_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				currentVirtualComponent = "tUniqRow_3";
					...
					public int compare(rowStruct_tUniqRow_3 arg0,
						...
						if (arg0.Path == null) {
							...
							if (arg1.Path == null) {
								...
								compare = arg0.Path.compareTo(arg1.Path);
								if (compare != 0) {
									return compare;
								}
							}
				...
				try {
					...
					while (limittFileInputDelimited_9 != 0
						...
						try {
							...
							if (rowtFileInputDelimited_9.length == 1
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.Name = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.Path = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.DataType = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.PathID = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.visual = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.codeList = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.source = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.xml = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row16.m_applied_path = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
						...
						if (row16 != null) {
							...
							row2.HLEVEL = row16.HLEVEL;
							row2.Name = row16.Name;
							row2.Path = row16.Path;
							row2.DataType = row16.DataType;
							row2.Update_Date = row16.Update_Date;
							row2.Import_Date = row16.Import_Date;
							row2.Download_Date = row16.Download_Date;
							row2.PathID = row16.PathID;
							row2.visual = row16.visual;
							row2.codeList = row16.codeList;
							row2.source = row16.source;
							row2.xml = row16.xml;
							row2.m_applied_path = row16.m_applied_path;
				...
				start_Hash.put("tUniqRow_3_UniqIn", System.currentTimeMillis());
				...
				while (rowList_1_tUniqRow_3.size() > 0) {
					...
					if (fri.hasNext()) {
						...
						fri.close();
						rowFileList_1_tUniqRow_3.remove(minIndex_tUniqRow_3);
					...
					for (int i = 0; i < rowList_1_tUniqRow_3.size();) {
						if (rowList_1_tUniqRow_3.get(i).duplicateTo(minItem)) {
							...
							if (noDuplicateItem == null) {
								...
								rowList_1_tUniqRow_3.set(i, noDuplicateItem);
								i++;
							}
						} else {
							i++;
				...
				if (rowsInBuffer_2_tUniqRow_3 > 0) {
					...
					java.util.Arrays.<rowStruct_tUniqRow_3> sort(
							buffer_2_tUniqRow_3, 0, rowsInBuffer_2_tUniqRow_3,
							comparator_2_tUniqRow_3);

					java.io.File file = new java.io.File(
							workDirectory_tUniqRow_3 + "/tUniqRow_3_TEMP_uniq_"
									+ files_2_tUniqRow_3.size());
				...
				while (rowList_2_tUniqRow_3.size() > 0) {
					...
					if (fri.hasNext()) {
						...
						fri.close();
						rowFileList_2_tUniqRow_3.remove(minIndex_tUniqRow_3);
			...
			try {
				...
				/**
				 * [tUniqRow_3_UniqOut finally ] start
				 */
				...
				/**
				 * [tUniqRow_3_UniqOut finally ] stop
				 */

				/**
				 * [tUniqRow_3_UniqIn finally ] start
				 */
				...
				/**
				 * [tUniqRow_3_UniqIn finally ] stop
				 */
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			try {
				...
				/**
				 * [tAdvancedHash_fromOnt finally ] start
				 */

				currentComponent = "tAdvancedHash_fromOnt";

				/**
				 * [tAdvancedHash_fromOnt finally ] stop
				 */
	...
	public void tCreateTemporaryFile_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String name_tCreateTemporaryFile_6 = "talend232323231_XXXX"
						.replaceAll("XXXX", routines.TalendString
								.getAsciiRandomString(4).toUpperCase());
		...
		try {
			...
			java.io.InputStream inContext = CSV_Patient_Data.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/csv_patient_data_0_1/contexts/"
...
/************************************************************************************************
 * 510805 characters generated by Talend Open Studio for Data Integration on the
 * March 11, 2015 1:16:45 PM CET
 ************************************************************************************************/
