...
/**
 * Job: OPS_1 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class OPS_1 implements TalendJob {
	...
	private final String jobName = "OPS_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(OPS_1.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_ops", new java.io.FileOutputStream(
						context.p21_output + "OPS.csv", false));
	...
	public static class ops_outStruct implements
			routines.system.IPersistableRow<ops_outStruct> {
		final static byte[] commonByteArrayLock_TOS_OPS_1 = new byte[0];
		static byte[] commonByteArray_TOS_OPS_1 = new byte[0];
		...
		public String OPS_VERSION;

		public String getOPS_VERSION() {
			return this.OPS_VERSION;
		}

		public String OPS_KODE;

		public String getOPS_KODE() {
			return this.OPS_KODE;
		}
		...
		public String OPS_DATUM;

		public String getOPS_DATUM() {
			return this.OPS_DATUM;
		}

		public String BELEGOPERATEUR;

		public String getBELEGOPERATEUR() {
			return this.BELEGOPERATEUR;
		}

		public String BELEGANAESTHESIST;

		public String getBELEGANAESTHESIST() {
			return this.BELEGANAESTHESIST;
		}

		public String BELEGHEBAMME;

		public String getBELEGHEBAMME() {
			return this.BELEGHEBAMME;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_OPS_1.length) {
					if (length < 1024 && commonByteArray_TOS_OPS_1.length == 0) {
						commonByteArray_TOS_OPS_1 = new byte[1024];
					} else {
						commonByteArray_TOS_OPS_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_OPS_1, 0, length);
				strReturn = new String(commonByteArray_TOS_OPS_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_OPS_1) {
				...
				try {
					...
					this.OPS_VERSION = readString(dis);

					this.OPS_KODE = readString(dis);

					this.LOKALISATION = readString(dis);

					this.OPS_DATUM = readString(dis);

					this.BELEGOPERATEUR = readString(dis);

					this.BELEGANAESTHESIST = readString(dis);

					this.BELEGHEBAMME = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.OPS_VERSION, dos);

				// String

				writeString(this.OPS_KODE, dos);
				...
				writeString(this.OPS_DATUM, dos);

				// String

				writeString(this.BELEGOPERATEUR, dos);

				// String

				writeString(this.BELEGANAESTHESIST, dos);

				// String

				writeString(this.BELEGHEBAMME, dos);
		...
		public String toString() {
			...
			sb.append(",OPS_VERSION=" + OPS_VERSION);
			sb.append(",OPS_KODE=" + OPS_KODE);
			sb.append(",LOKALISATION=" + LOKALISATION);
			sb.append(",OPS_DATUM=" + OPS_DATUM);
			sb.append(",BELEGOPERATEUR=" + BELEGOPERATEUR);
			sb.append(",BELEGANAESTHESIST=" + BELEGANAESTHESIST);
			sb.append(",BELEGHEBAMME=" + BELEGHEBAMME);
		 ...
		 * Compare keys
		 */
		public int compareTo(ops_outStruct other) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ops_outStruct ops_out = new ops_outStruct();
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_ops"),
						"ISO-8859-15");
				...
				outtFileOutputDelimited_1.write("OPS_VERSION");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("OPS_KODE");
				...
				outtFileOutputDelimited_1.write("OPS_DATUM");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("BELEGOPERATEUR");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("BELEGANAESTHESIST");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("BELEGHEBAMME");
				...
				ops_outStruct ops_out_tmp = new ops_outStruct();
				// ###############################
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "ops.csv", "windows-1252",
								";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.OPS_VERSION = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.OPS_KODE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.OPS_DATUM = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.BELEGOPERATEUR = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.BELEGANAESTHESIST = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.BELEGHEBAMME = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'ops_out'
									ops_out_tmp.IK = row1.IK;
									ops_out_tmp.ENTLASSENDER_STANDORT = row1.ENTLASSENDER_STANDORT;
									ops_out_tmp.ENTGELTBEREICH = row1.ENTGELTBEREICH;
									ops_out_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_INTERNES_KENNZEICHEN;
									ops_out_tmp.OPS_VERSION = row1.OPS_VERSION;
									ops_out_tmp.OPS_KODE = row1.OPS_KODE;
									ops_out_tmp.LOKALISATION = row1.LOKALISATION;
									ops_out_tmp.OPS_DATUM = row1.OPS_DATUM;
									ops_out_tmp.BELEGOPERATEUR = row1.BELEGOPERATEUR;
									ops_out_tmp.BELEGANAESTHESIST = row1.BELEGANAESTHESIST;
									ops_out_tmp.BELEGHEBAMME = row1.BELEGHEBAMME;
									ops_out_tmp.PATIENTENNR = row2.PATIENTENNUMMER;
									ops_out = ops_out_tmp;
							...
							if (ops_out != null) {
								...
								if (ops_out.ENTLASSENDER_STANDORT != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.ENTLASSENDER_STANDORT
								...
								if (ops_out.ENTGELTBEREICH != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.ENTGELTBEREICH
								...
								if (ops_out.KH_INTERNES_KENNZEICHEN != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.KH_INTERNES_KENNZEICHEN
								...
								if (ops_out.LOKALISATION != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.LOKALISATION
								...
								if (ops_out.BELEGOPERATEUR != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.BELEGOPERATEUR
								...
								if (ops_out.BELEGANAESTHESIST != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.BELEGANAESTHESIST
								...
								if (ops_out.BELEGHEBAMME != null) {

									sb_tFileOutputDelimited_1.append(

									ops_out.BELEGHEBAMME
					...
					if (!((Object) (context.p21_input + "ops.csv") instanceof java.io.InputStream)) {
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				((java.io.FileOutputStream) globalMap.get("out_file_ops"))
						.close();
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(ops_out)
	...
	public static void main(String[] args) {
		final OPS_1 OPS_1Class = new OPS_1();

		int exitCode = OPS_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = OPS_1.class.getClassLoader()
					.getResourceAsStream(
							"tos/ops_1_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : OPS_1");
		}
...
/************************************************************************************************
 * 104225 characters generated by Talend Open Studio for Data Integration on the
