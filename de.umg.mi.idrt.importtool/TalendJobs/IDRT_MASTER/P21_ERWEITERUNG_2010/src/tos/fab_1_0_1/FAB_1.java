...
/**
 * Job: FAB_1 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class FAB_1 implements TalendJob {
	...
	private final String jobName = "FAB_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FAB_1.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_fab", new java.io.FileOutputStream(
						context.p21_output + "FAB.csv", false));
	...
	public static class fab_erweitertStruct implements
			routines.system.IPersistableRow<fab_erweitertStruct> {
		final static byte[] commonByteArrayLock_TOS_FAB_1 = new byte[0];
		static byte[] commonByteArray_TOS_FAB_1 = new byte[0];
		...
		public String FAB_AUFNAHMEDATUM;

		public String getFAB_AUFNAHMEDATUM() {
			return this.FAB_AUFNAHMEDATUM;
		}

		public String FAB_ENTLASSUNGSDATUM;

		public String getFAB_ENTLASSUNGSDATUM() {
			return this.FAB_ENTLASSUNGSDATUM;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_FAB_1.length) {
					if (length < 1024 && commonByteArray_TOS_FAB_1.length == 0) {
						commonByteArray_TOS_FAB_1 = new byte[1024];
					} else {
						commonByteArray_TOS_FAB_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_FAB_1, 0, length);
				strReturn = new String(commonByteArray_TOS_FAB_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_FAB_1) {
				...
				try {
					...
					this.FAB = readString(dis);

					this.FAB_AUFNAHMEDATUM = readString(dis);

					this.FAB_ENTLASSUNGSDATUM = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.FAB, dos);

				// String

				writeString(this.FAB_AUFNAHMEDATUM, dos);

				// String

				writeString(this.FAB_ENTLASSUNGSDATUM, dos);
		...
		public String toString() {
			...
			sb.append(",FAB=" + FAB);
			sb.append(",FAB_AUFNAHMEDATUM=" + FAB_AUFNAHMEDATUM);
			sb.append(",FAB_ENTLASSUNGSDATUM=" + FAB_ENTLASSUNGSDATUM);
		 ...
		 * Compare keys
		 */
		public int compareTo(fab_erweitertStruct other) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fab_erweitertStruct fab_erweitert = new fab_erweitertStruct();
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_fab"),
						"ISO-8859-15");
				...
				outtFileOutputDelimited_1.write("FAB");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FAB_AUFNAHMEDATUM");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FAB_ENTLASSUNGSDATUM");
				...
				fab_erweitertStruct fab_erweitert_tmp = new fab_erweitertStruct();
				// ###############################
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "fab.csv", "windows-1252",
								";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.FAB = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.FAB_AUFNAHMEDATUM = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.FAB_ENTLASSUNGSDATUM = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'fab_erweitert'
									fab_erweitert_tmp.IK = row1.IK;
									fab_erweitert_tmp.ENTLASSENDER_STANDORT = row1.ENTLASSENDER_STANDORT;
									fab_erweitert_tmp.ENTGELTBEREICH = row1.ENTGELTBEREICH;
									fab_erweitert_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_INTERNES_KENNZEICHEN;
									fab_erweitert_tmp.FAB = row1.FAB;
									fab_erweitert_tmp.FAB_AUFNAHMEDATUM = row1.FAB_AUFNAHMEDATUM;
									fab_erweitert_tmp.FAB_ENTLASSUNGSDATUM = row1.FAB_ENTLASSUNGSDATUM;
									fab_erweitert_tmp.PATIENTENNR = row2.PATIENTENNUMMER;
									fab_erweitert = fab_erweitert_tmp;
							 ...
							 * [tMap_1 main ] stop
							 */
							// Start of branch "fab_erweitert"
							if (fab_erweitert != null) {
								...
								if (fab_erweitert.ENTLASSENDER_STANDORT != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.ENTLASSENDER_STANDORT
								...
								if (fab_erweitert.ENTGELTBEREICH != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.ENTGELTBEREICH
								...
								if (fab_erweitert.KH_INTERNES_KENNZEICHEN != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.KH_INTERNES_KENNZEICHEN
								...
								if (fab_erweitert.FAB_AUFNAHMEDATUM != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.FAB_AUFNAHMEDATUM
								...
								if (fab_erweitert.FAB_ENTLASSUNGSDATUM != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.FAB_ENTLASSUNGSDATUM
								...
								if (fab_erweitert.PATIENTENNR != null) {

									sb_tFileOutputDelimited_1.append(

									fab_erweitert.PATIENTENNR
					...
					if (!((Object) (context.p21_input + "fab.csv") instanceof java.io.InputStream)) {
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				((java.io.FileOutputStream) globalMap.get("out_file_fab"))
						.close();
	...
	public static void main(String[] args) {
		final FAB_1 FAB_1Class = new FAB_1();

		int exitCode = FAB_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FAB_1.class.getClassLoader()
					.getResourceAsStream(
							"tos/fab_1_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : FAB_1");
		}
...
/************************************************************************************************
 * 98046 characters generated by Talend Open Studio for Data Integration on the
