...
/**
 * Job: ICD_1 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class ICD_1 implements TalendJob {
	...
	private final String jobName = "ICD_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ICD_1.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_icd", new java.io.FileOutputStream(
	...
	public static class icd_outStruct implements
			routines.system.IPersistableRow<icd_outStruct> {
		final static byte[] commonByteArrayLock_TOS_ICD_1 = new byte[0];
		static byte[] commonByteArray_TOS_ICD_1 = new byte[0];
		...
		public String LOKALISATION1;

		public String getLOKALISATION1() {
			return this.LOKALISATION1;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_ICD_1.length) {
					if (length < 1024 && commonByteArray_TOS_ICD_1.length == 0) {
						commonByteArray_TOS_ICD_1 = new byte[1024];
					} else {
						commonByteArray_TOS_ICD_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_ICD_1, 0, length);
				strReturn = new String(commonByteArray_TOS_ICD_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_ICD_1) {
				...
				try {
					...
					this.LOKALISATION1 = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.LOKALISATION1, dos);
		...
		public String toString() {
			...
			sb.append(",LOKALISATION1=" + LOKALISATION1);
		 ...
		 * Compare keys
		 */
		public int compareTo(icd_outStruct other) {
	...
	public void tFileInputDelimited_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				icd_outStruct icd_out = new icd_outStruct();
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_icd"),
						"ISO-8859-15");
				...
				outtFileOutputDelimited_1.write("LOKALISATION1");
				...
				icd_outStruct icd_out_tmp = new icd_outStruct();
				// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = context.p21_input
							+ "icd.csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "icd.csv", "windows-1252",
								";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							row1.IK = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							row1.ENTLASSENDER_STANDORT = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 2;

							row1.ENTGELTBEREICH = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 3;

							row1.KH_INTERNES_KENNZEICHEN = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 4;

							row1.DIAGNOSEART = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 5;

							row1.ICD_VERSION = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							row1.ICD_KODE = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 7;

							row1.LOKALISATION = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 8;

							row1.SEKUNDAER_KODE = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 9;

							row1.LOKALISATION1 = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'icd_out'
									icd_out_tmp.IK = row1.IK;
									icd_out_tmp.ENTLASSENDER_STANDORT = row1.ENTLASSENDER_STANDORT;
									icd_out_tmp.ENTGELTBEREICH = row1.ENTGELTBEREICH;
									icd_out_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_INTERNES_KENNZEICHEN;
									icd_out_tmp.DIAGNOSEART = row1.DIAGNOSEART;
									icd_out_tmp.ICD_VERSION = row1.ICD_VERSION;
									icd_out_tmp.ICD_KODE = row1.ICD_KODE;
									icd_out_tmp.LOKALISATION = row1.LOKALISATION;
									icd_out_tmp.SEKUNDAER_KODE = row1.SEKUNDAER_KODE;
									icd_out_tmp.LOKALISATION1 = row1.LOKALISATION1;
									icd_out_tmp.PATIENTENNR = row2.PATIENTENNUMMER;
									icd_out = icd_out_tmp;
							...
							if (icd_out != null) {
								...
								if (icd_out.ENTLASSENDER_STANDORT != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.ENTLASSENDER_STANDORT
								...
								if (icd_out.ENTGELTBEREICH != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.ENTGELTBEREICH
								...
								if (icd_out.KH_INTERNES_KENNZEICHEN != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.KH_INTERNES_KENNZEICHEN
								...
								if (icd_out.LOKALISATION != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.LOKALISATION
								...
								if (icd_out.SEKUNDAER_KODE != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.SEKUNDAER_KODE
								...
								if (icd_out.LOKALISATION1 != null) {

									sb_tFileOutputDelimited_1.append(

									icd_out.LOKALISATION1
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				((java.io.FileOutputStream) globalMap.get("out_file_icd"))
						.close();
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// inputs:(after_tFileInputDelimited_3) outputs:(row2,row2) |
				// target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(icd_out)
	...
	public static void main(String[] args) {
		final ICD_1 ICD_1Class = new ICD_1();

		int exitCode = ICD_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ICD_1.class.getClassLoader()
					.getResourceAsStream(
							"tos/icd_1_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ICD_1");
		}
...
/************************************************************************************************
 * 102530 characters generated by Talend Open Studio for Data Integration on the
