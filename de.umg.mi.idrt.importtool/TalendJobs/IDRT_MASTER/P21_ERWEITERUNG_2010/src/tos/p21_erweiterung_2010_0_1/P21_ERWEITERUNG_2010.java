...
package tos.p21_erweiterung_2010_0_1;
...
public class P21_ERWEITERUNG_2010 implements TalendJob {
	...
	private final String jobName = "P21_ERWEITERUNG_2010";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					P21_ERWEITERUNG_2010.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(P21_ERWEITERUNG_2010.this, new Object[] {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("DRG preprocessing");
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				tos.drg_1_0_1.DRG_1 childJob_tRunJob_1 = new tos.drg_1_0_1.DRG_1();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				tos.fab_1_0_1.FAB_1 childJob_tRunJob_2 = new tos.fab_1_0_1.FAB_1();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				tos.icd_1_0_1.ICD_1 childJob_tRunJob_3 = new tos.icd_1_0_1.ICD_1();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_4.put("p21_input", context.p21_input);
				...
				tos.ops_1_0_1.OPS_1 childJob_tRunJob_4 = new tos.ops_1_0_1.OPS_1();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_4:OnSubjobOk1",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_4:OnSubjobOk2",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_P21_ERWEITERUNG_2010 = new byte[0];
		static byte[] commonByteArray_TOS_P21_ERWEITERUNG_2010 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_P21_ERWEITERUNG_2010.length) {
					if (length < 1024
							&& commonByteArray_TOS_P21_ERWEITERUNG_2010.length == 0) {
						commonByteArray_TOS_P21_ERWEITERUNG_2010 = new byte[1024];
					} else {
						commonByteArray_TOS_P21_ERWEITERUNG_2010 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_P21_ERWEITERUNG_2010, 0,
						length);
				strReturn = new String(
						commonByteArray_TOS_P21_ERWEITERUNG_2010, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_P21_ERWEITERUNG_2010) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write("INTERKURRENTE_DIALYSEN");
					...
					outtFileOutputDelimited_1
							.write("BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "fall.csv", "ISO-8859-15",
								";", "\n", true, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							if (row1.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH != null) {

								sb_tFileOutputDelimited_1.append(

								row1.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH
	...
	public static void main(String[] args) {
		final P21_ERWEITERUNG_2010 P21_ERWEITERUNG_2010Class = new P21_ERWEITERUNG_2010();

		int exitCode = P21_ERWEITERUNG_2010Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = P21_ERWEITERUNG_2010.class
					.getClassLoader().getResourceAsStream(
							"tos/p21_erweiterung_2010_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : P21_ERWEITERUNG_2010");
		}
...
/************************************************************************************************
 * 113108 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 4:23:38 PM CEST
 ************************************************************************************************/
