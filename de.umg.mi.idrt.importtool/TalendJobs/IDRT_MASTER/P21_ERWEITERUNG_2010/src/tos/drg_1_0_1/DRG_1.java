...
/**
 * Job: DRG_1 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class DRG_1 implements TalendJob {
	...
	private final String jobName = "DRG_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DRG_1.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				globalMap.put("out_file_drg", new java.io.FileOutputStream(
						context.p21_output + "DRG.csv", false));
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_DRG_1 = new byte[0];
		static byte[] commonByteArray_TOS_DRG_1 = new byte[0];
		...
		public String RELGEW;

		public String getRELGEW() {
			return this.RELGEW;
		}

		public String ABSCHLAGGEW;

		public String getABSCHLAGGEW() {
			return this.ABSCHLAGGEW;
		}

		public String ABSCHLAGTAGE;

		public String getABSCHLAGTAGE() {
			return this.ABSCHLAGTAGE;
		}

		public String ABSCHLAGVERLGEW;

		public String getABSCHLAGVERLGEW() {
			return this.ABSCHLAGVERLGEW;
		}

		public String ABSCHLAGVERLTAGE;

		public String getABSCHLAGVERLTAGE() {
			return this.ABSCHLAGVERLTAGE;
		}

		public String ZUSCHLAGGEW;

		public String getZUSCHLAGGEW() {
			return this.ZUSCHLAGGEW;
		}

		public String ZUSCHLAGTAGE;

		public String getZUSCHLAGTAGE() {
			return this.ZUSCHLAGTAGE;
		}

		public String ZUSCHLAGKOOPBETRAG;

		public String getZUSCHLAGKOOPBETRAG() {
			return this.ZUSCHLAGKOOPBETRAG;
		}

		public String EFFGEW;

		public String getEFFGEW() {
			return this.EFFGEW;
		}

		public String ENTGSTATUS;

		public String getENTGSTATUS() {
			return this.ENTGSTATUS;
		}
		...
		public String VWDVERWENDET;

		public String getVWDVERWENDET() {
			return this.VWDVERWENDET;
		}

		public String FLAGVWD;

		public String getFLAGVWD() {
			return this.FLAGVWD;
		}

		public String FLAGALTER;

		public String getFLAGALTER() {
			return this.FLAGALTER;
		}

		public String FLAGGESCHLECHT;

		public String getFLAGGESCHLECHT() {
			return this.FLAGGESCHLECHT;
		}

		public String FLAGTAGESFALL;

		public String getFLAGTAGESFALL() {
			return this.FLAGTAGESFALL;
		}

		public String FLAGENTLGRUND;

		public String getFLAGENTLGRUND() {
			return this.FLAGENTLGRUND;
		}

		public String FLAGAUFNGEWICHT1;

		public String getFLAGAUFNGEWICHT1() {
			return this.FLAGAUFNGEWICHT1;
		}

		public String FLAGAUFNGEWICHT2;

		public String getFLAGAUFNGEWICHT2() {
			return this.FLAGAUFNGEWICHT2;
		}

		public String FLAGANZBEATMUNGSTD;

		public String getFLAGANZBEATMUNGSTD() {
			return this.FLAGANZBEATMUNGSTD;
		}

		public String FLAGEINWEISUNG;

		public String getFLAGEINWEISUNG() {
			return this.FLAGEINWEISUNG;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_DRG_1.length) {
					if (length < 1024 && commonByteArray_TOS_DRG_1.length == 0) {
						commonByteArray_TOS_DRG_1 = new byte[1024];
					} else {
						commonByteArray_TOS_DRG_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_DRG_1, 0, length);
				strReturn = new String(commonByteArray_TOS_DRG_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_DRG_1) {
				...
				try {
					...
					this.DRGCODE = readString(dis);

					this.MDC = readString(dis);

					this.PCCL = readString(dis);

					this.GST = readString(dis);

					this.RELGEW = readString(dis);

					this.ABSCHLAGGEW = readString(dis);

					this.ABSCHLAGTAGE = readString(dis);

					this.ABSCHLAGVERLGEW = readString(dis);

					this.ABSCHLAGVERLTAGE = readString(dis);

					this.ZUSCHLAGGEW = readString(dis);

					this.ZUSCHLAGTAGE = readString(dis);

					this.ZUSCHLAGKOOPBETRAG = readString(dis);

					this.EFFGEW = readString(dis);

					this.ENTGSTATUS = readString(dis);

					this.PATIENTSTATUS = readString(dis);

					this.VWDVERWENDET = readString(dis);

					this.FLAGVWD = readString(dis);

					this.FLAGALTER = readString(dis);

					this.FLAGGESCHLECHT = readString(dis);

					this.FLAGTAGESFALL = readString(dis);

					this.FLAGENTLGRUND = readString(dis);

					this.FLAGAUFNGEWICHT1 = readString(dis);

					this.FLAGAUFNGEWICHT2 = readString(dis);

					this.FLAGANZBEATMUNGSTD = readString(dis);

					this.FLAGEINWEISUNG = readString(dis);

					this.DRGVERSION = readString(dis);

					this.BASISRATE = readString(dis);

					this.ABTTYP = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.DRGCODE, dos);

				// String

				writeString(this.MDC, dos);

				// String

				writeString(this.PCCL, dos);

				// String

				writeString(this.GST, dos);

				// String

				writeString(this.RELGEW, dos);

				// String

				writeString(this.ABSCHLAGGEW, dos);

				// String

				writeString(this.ABSCHLAGTAGE, dos);

				// String

				writeString(this.ABSCHLAGVERLGEW, dos);

				// String

				writeString(this.ABSCHLAGVERLTAGE, dos);

				// String

				writeString(this.ZUSCHLAGGEW, dos);

				// String

				writeString(this.ZUSCHLAGTAGE, dos);

				// String

				writeString(this.ZUSCHLAGKOOPBETRAG, dos);

				// String

				writeString(this.EFFGEW, dos);

				// String

				writeString(this.ENTGSTATUS, dos);

				// String

				writeString(this.PATIENTSTATUS, dos);

				// String

				writeString(this.VWDVERWENDET, dos);

				// String

				writeString(this.FLAGVWD, dos);

				// String

				writeString(this.FLAGALTER, dos);

				// String

				writeString(this.FLAGGESCHLECHT, dos);

				// String

				writeString(this.FLAGTAGESFALL, dos);

				// String

				writeString(this.FLAGENTLGRUND, dos);

				// String

				writeString(this.FLAGAUFNGEWICHT1, dos);

				// String

				writeString(this.FLAGAUFNGEWICHT2, dos);

				// String

				writeString(this.FLAGANZBEATMUNGSTD, dos);

				// String

				writeString(this.FLAGEINWEISUNG, dos);

				// String

				writeString(this.DRGVERSION, dos);

				// String

				writeString(this.BASISRATE, dos);

				// String

				writeString(this.ABTTYP, dos);
		...
		public String toString() {
			...
			sb.append(",DRGCODE=" + DRGCODE);
			sb.append(",MDC=" + MDC);
			sb.append(",PCCL=" + PCCL);
			sb.append(",GST=" + GST);
			sb.append(",RELGEW=" + RELGEW);
			sb.append(",ABSCHLAGGEW=" + ABSCHLAGGEW);
			sb.append(",ABSCHLAGTAGE=" + ABSCHLAGTAGE);
			sb.append(",ABSCHLAGVERLGEW=" + ABSCHLAGVERLGEW);
			sb.append(",ABSCHLAGVERLTAGE=" + ABSCHLAGVERLTAGE);
			sb.append(",ZUSCHLAGGEW=" + ZUSCHLAGGEW);
			sb.append(",ZUSCHLAGTAGE=" + ZUSCHLAGTAGE);
			sb.append(",ZUSCHLAGKOOPBETRAG=" + ZUSCHLAGKOOPBETRAG);
			sb.append(",EFFGEW=" + EFFGEW);
			sb.append(",ENTGSTATUS=" + ENTGSTATUS);
			sb.append(",PATIENTSTATUS=" + PATIENTSTATUS);
			sb.append(",VWDVERWENDET=" + VWDVERWENDET);
			sb.append(",FLAGVWD=" + FLAGVWD);
			sb.append(",FLAGALTER=" + FLAGALTER);
			sb.append(",FLAGGESCHLECHT=" + FLAGGESCHLECHT);
			sb.append(",FLAGTAGESFALL=" + FLAGTAGESFALL);
			sb.append(",FLAGENTLGRUND=" + FLAGENTLGRUND);
			sb.append(",FLAGAUFNGEWICHT1=" + FLAGAUFNGEWICHT1);
			sb.append(",FLAGAUFNGEWICHT2=" + FLAGAUFNGEWICHT2);
			sb.append(",FLAGANZBEATMUNGSTD=" + FLAGANZBEATMUNGSTD);
			sb.append(",FLAGEINWEISUNG=" + FLAGEINWEISUNG);
			sb.append(",DRGVERSION=" + DRGVERSION);
			sb.append(",BASISRATE=" + BASISRATE);
			sb.append(",ABTTYP=" + ABTTYP);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				writer_tFileOutputDelimited_1 = new java.io.OutputStreamWriter(
						(java.io.OutputStream) globalMap.get("out_file_drg"),
						"ISO-8859-15");
				...
				outtFileOutputDelimited_1.write("DRGCODE");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("MDC");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("PCCL");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("GST");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("RELGEW");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ABSCHLAGGEW");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ABSCHLAGTAGE");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ABSCHLAGVERLGEW");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ABSCHLAGVERLTAGE");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ZUSCHLAGGEW");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ZUSCHLAGTAGE");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ZUSCHLAGKOOPBETRAG");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("EFFGEW");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ENTGSTATUS");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("PATIENTSTATUS");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("VWDVERWENDET");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGVWD");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGALTER");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGGESCHLECHT");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGTAGESFALL");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGENTLGRUND");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGAUFNGEWICHT1");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGAUFNGEWICHT2");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGANZBEATMUNGSTD");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("FLAGEINWEISUNG");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("DRGVERSION");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("BASISRATE");

				outtFileOutputDelimited_1
						.write(OUT_DELIM_tFileOutputDelimited_1);

				outtFileOutputDelimited_1.write("ABTTYP");
				...
				resourceMap.put("out_tFileOutputDelimited_1",
						outtFileOutputDelimited_1);
				resourceMap.put("writer_tFileOutputDelimited_1",
						writer_tFileOutputDelimited_1);
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "drg.csv", "windows-1252",
								";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.DRGCODE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.MDC = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.PCCL = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.GST = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.RELGEW = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							row1.ABSCHLAGGEW = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.ABSCHLAGTAGE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.ABSCHLAGVERLGEW = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.ABSCHLAGVERLTAGE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							row1.ZUSCHLAGGEW = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.ZUSCHLAGTAGE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.ZUSCHLAGKOOPBETRAG = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 14;

							row1.EFFGEW = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 15;

							row1.ENTGSTATUS = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							row1.PATIENTSTATUS = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 17;

							row1.VWDVERWENDET = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 18;

							row1.FLAGVWD = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 19;

							row1.FLAGALTER = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 20;

							row1.FLAGGESCHLECHT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 21;

							row1.FLAGTAGESFALL = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 22;

							row1.FLAGENTLGRUND = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 23;

							row1.FLAGAUFNGEWICHT1 = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 24;

							row1.FLAGAUFNGEWICHT2 = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 25;

							row1.FLAGANZBEATMUNGSTD = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 26;

							row1.FLAGEINWEISUNG = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 27;

							row1.DRGVERSION = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 28;

							row1.BASISRATE = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 29;

							row1.ABTTYP = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'out1'
									out1_tmp.IK = row1.IK;
									out1_tmp.KH_INTERNES_KENNZEICHEN = row1.KH_INTERNES_KENNZEICHEN;
									out1_tmp.DRGCODE = row1.DRGCODE;
									out1_tmp.MDC = row1.MDC;
									out1_tmp.PCCL = row1.PCCL;
									out1_tmp.GST = row1.GST;
									out1_tmp.RELGEW = row1.RELGEW;
									out1_tmp.ABSCHLAGGEW = row1.ABSCHLAGGEW;
									out1_tmp.ABSCHLAGTAGE = row1.ABSCHLAGTAGE;
									out1_tmp.ABSCHLAGVERLGEW = row1.ABSCHLAGVERLGEW;
									out1_tmp.ABSCHLAGVERLTAGE = row1.ABSCHLAGVERLTAGE;
									out1_tmp.ZUSCHLAGGEW = row1.ZUSCHLAGGEW;
									out1_tmp.ZUSCHLAGTAGE = row1.ZUSCHLAGTAGE;
									out1_tmp.ZUSCHLAGKOOPBETRAG = row1.ZUSCHLAGKOOPBETRAG;
									out1_tmp.EFFGEW = row1.EFFGEW;
									out1_tmp.ENTGSTATUS = row1.ENTGSTATUS;
									out1_tmp.PATIENTSTATUS = row1.PATIENTSTATUS;
									out1_tmp.VWDVERWENDET = row1.VWDVERWENDET;
									out1_tmp.FLAGVWD = row1.FLAGVWD;
									out1_tmp.FLAGALTER = row1.FLAGALTER;
									out1_tmp.FLAGGESCHLECHT = row1.FLAGGESCHLECHT;
									out1_tmp.FLAGTAGESFALL = row1.FLAGTAGESFALL;
									out1_tmp.FLAGENTLGRUND = row1.FLAGENTLGRUND;
									out1_tmp.FLAGAUFNGEWICHT1 = row1.FLAGAUFNGEWICHT1;
									out1_tmp.FLAGAUFNGEWICHT2 = row1.FLAGAUFNGEWICHT2;
									out1_tmp.FLAGANZBEATMUNGSTD = row1.FLAGANZBEATMUNGSTD;
									out1_tmp.FLAGEINWEISUNG = row1.FLAGEINWEISUNG;
									out1_tmp.DRGVERSION = row1.DRGVERSION;
									out1_tmp.BASISRATE = row1.BASISRATE;
									out1_tmp.ABTTYP = row1.ABTTYP;
									out1_tmp.PATIENTENNR = row2.PATIENTENNUMMER;
									out1 = out1_tmp;
							...
							if (out1 != null) {
								...
								if (out1.KH_INTERNES_KENNZEICHEN != null) {

									sb_tFileOutputDelimited_1.append(

									out1.KH_INTERNES_KENNZEICHEN
								...
								if (out1.ABSCHLAGVERLGEW != null) {

									sb_tFileOutputDelimited_1.append(

									out1.ABSCHLAGVERLGEW
								...
								if (out1.ABSCHLAGVERLTAGE != null) {

									sb_tFileOutputDelimited_1.append(

									out1.ABSCHLAGVERLTAGE
								...
								if (out1.ZUSCHLAGKOOPBETRAG != null) {

									sb_tFileOutputDelimited_1.append(

									out1.ZUSCHLAGKOOPBETRAG
								...
								if (out1.FLAGAUFNGEWICHT1 != null) {

									sb_tFileOutputDelimited_1.append(

									out1.FLAGAUFNGEWICHT1
								...
								if (out1.FLAGAUFNGEWICHT2 != null) {

									sb_tFileOutputDelimited_1.append(

									out1.FLAGAUFNGEWICHT2
								...
								if (out1.FLAGANZBEATMUNGSTD != null) {

									sb_tFileOutputDelimited_1.append(

									out1.FLAGANZBEATMUNGSTD
					...
					if (!((Object) (context.p21_input + "drg.csv") instanceof java.io.InputStream)) {
			...
			try {
				...
				if (resourceMap.get("finish_tFileOutputDelimited_1") == null) {
					...
					java.io.OutputStreamWriter writer_tFileOutputDelimited_1 = (java.io.OutputStreamWriter) resourceMap
							.get("writer_tFileOutputDelimited_1");
					if (outtFileOutputDelimited_1 != null) {
						outtFileOutputDelimited_1.flush();
						writer_tFileOutputDelimited_1.flush();
						outtFileOutputDelimited_1 = null;
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				((java.io.FileOutputStream) globalMap.get("out_file_drg"))
						.close();
	...
	public static class row2Struct implements
		...
		public Character FALLZUSAMMENFUEHRUNG;

		public Character getFALLZUSAMMENFUEHRUNG() {
		...
		public Integer ALTER_IN_JAHREN_AM_AUFNAHMETAG;

		public Integer getALTER_IN_JAHREN_AM_AUFNAHMETAG() {
		...
		public String BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH;

		public String getBELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH() {
			return this.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH;
		}
		...
		public void copyDataTo(row2Struct other) {
			...
			other.FALLZUSAMMENFUEHRUNG = this.FALLZUSAMMENFUEHRUNG;
			other.FALLZUSAMMENFUEHRUNGSGRUND = this.FALLZUSAMMENFUEHRUNGSGRUND;
			...
			other.BEHANDLUNGSBEGINN_VORSTATIONAER = this.BEHANDLUNGSBEGINN_VORSTATIONAER;
			...
			other.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH = this.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				length = dis.readByte();
				if (length == -1) {
					this.FALLZUSAMMENFUEHRUNG = null;
				} else {
					this.FALLZUSAMMENFUEHRUNG = dis.readChar();
				}

				this.FALLZUSAMMENFUEHRUNGSGRUND = readString(dis, ois);
				...
				this.ALTER_IN_JAHREN_AM_AUFNAHMETAG = readInteger(dis, ois);
				...
				this.BEHANDLUNGSBEGINN_VORSTATIONAER = readString(dis, ois);
				...
				this.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH = readString(dis,
						ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				if (this.FALLZUSAMMENFUEHRUNG == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeChar(this.FALLZUSAMMENFUEHRUNG);
				}

				writeString(this.FALLZUSAMMENFUEHRUNGSGRUND, dos, oos);
				...
				writeInteger(this.ALTER_IN_JAHREN_AM_AUFNAHMETAG, dos, oos);
				...
				writeString(this.BEHANDLUNGSBEGINN_VORSTATIONAER, dos, oos);
				...
				writeString(this.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH, dos,
						oos);
		...
		public String toString() {
			...
			sb.append(",FALLZUSAMMENFUEHRUNG="
					+ String.valueOf(FALLZUSAMMENFUEHRUNG));
			...
			sb.append(",ALTER_IN_JAHREN_AM_AUFNAHMETAG="
					+ String.valueOf(ALTER_IN_JAHREN_AM_AUFNAHMETAG));
			...
			sb.append(",BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH="
					+ BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH);
				...
				try {
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.p21_input + "fall.csv", "windows-1252",
								";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							if (temp.length() > 0) {
								...
								row2.FALLZUSAMMENFUEHRUNG = ParserUtils
										.parseTo_Character(temp);

							} else {

								row2.FALLZUSAMMENFUEHRUNG = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 13;

							row2.FALLZUSAMMENFUEHRUNGSGRUND = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								row2.ALTER_IN_JAHREN_AM_AUFNAHMETAG = ParserUtils
										.parseTo_Integer(temp);

							} else {

								row2.ALTER_IN_JAHREN_AM_AUFNAHMETAG = null;
							...
							row2.BEHANDLUNGSBEGINN_VORSTATIONAER = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
						...
						if (row2 != null) {
							...
							row2_HashRow.FALLZUSAMMENFUEHRUNG = row2.FALLZUSAMMENFUEHRUNG;

							row2_HashRow.FALLZUSAMMENFUEHRUNGSGRUND = row2.FALLZUSAMMENFUEHRUNGSGRUND;
							...
							row2_HashRow.BEHANDLUNGSBEGINN_VORSTATIONAER = row2.BEHANDLUNGSBEGINN_VORSTATIONAER;
							...
							row2_HashRow.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH = row2.BELEGUNGSTAGE_IN_ANDEREM_ENTGELTBEREICH;
	...
	public static void main(String[] args) {
		final DRG_1 DRG_1Class = new DRG_1();

		int exitCode = DRG_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = DRG_1.class.getClassLoader()
					.getResourceAsStream(
							"tos/drg_1_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : DRG_1");
		}
...
/************************************************************************************************
 * 133943 characters generated by Talend Open Studio for Data Integration on the
 * October 14, 2014 4:23:37 PM CEST
 ************************************************************************************************/
