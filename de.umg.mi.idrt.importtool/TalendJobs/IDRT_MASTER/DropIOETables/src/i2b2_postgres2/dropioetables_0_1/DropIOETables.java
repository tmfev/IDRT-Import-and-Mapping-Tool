...
package i2b2_postgres2.dropioetables_0_1;
...
/**
 * Job: DropIOETables Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class DropIOETables implements TalendJob {
	...
	private final String jobName = "DropIOETables";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					DropIOETables.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DropIOETables.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				Object[] values_tForeach_1 = new Object[] {
						"drop table i2b2metadata.ioe_target",
						"drop table i2b2metadata.ioe_target_ontology",
						"drop table i2b2metadata.ioe_target_project", };
	...
	public static void main(String[] args) {
		final DropIOETables DropIOETablesClass = new DropIOETables();

		int exitCode = DropIOETablesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = DropIOETables.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/dropioetables_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : DropIOETables");
		}
...
/************************************************************************************************
 * 46150 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2015 3:55:41 PM CET
 ************************************************************************************************/
