...
package i2b2_postgres2.mdr_query_dataelements_datatype_0_1;
...
/**
 * Job: MDR_Query_DataElements_dataType Purpose: Fragt mit MDRID (aus Context) MDR ab und liefert Ergebnisse (gefiltert)<br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class MDR_Query_DataElements_dataType implements TalendJob {
	...
	private final String jobName = "MDR_Query_DataElements_dataType";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MDR_Query_DataElements_dataType.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MDR_Query_DataElements_dataType.this,
	...
	public static class row52Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_MDR_Query_DataElements_dataType = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType.length == 0) {
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_dataType,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_MDR_Query_DataElements_dataType) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fileName_tFileOutputDelimited_17 = (new java.io.File(
						context.folderMain + context.folderTemp + "ont_dt"
				...
				fileName_tFileOutputDelimited_16 = (new java.io.File(
						context.folderMain + context.folderTemp + "temp_dt"
								+ context.DE_domain_ID + ".csv"))
						.getAbsolutePath().replace("\\", "/");
					...
					void setRowValue_0(
						...
						if (JSONResultList_tFileInputJSON_8.get(1) != null
								...
								&& JSONResultList_tFileInputJSON_8.get(1).get(
										nbResultArray_tFileInputJSON_8) != null) {
							row42.name = JSONResultList_tFileInputJSON_8.get(1)
									.get(nbResultArray_tFileInputJSON_8)
									.toString();
						} else {
				...
				for (int nbResultArray_tFileInputJSON_8 = 0; nbResultArray_tFileInputJSON_8 < recordMaxSize_tFileInputJSON_8; nbResultArray_tFileInputJSON_8++) {
					...
					if (row42 != null) {
						...
						{ // start of Var scope
							...
							Var.itemID = row42.id.substring(row42.id
									.lastIndexOf("@") + 1);
							Var.dataTypeSupportedByIDRT = row42.name
							...
							tMap6DE2Ont_Leafs_tmp.Path = context.ont_03_Path
									+ "\\" + Var.itemID + "\\";
							tMap6DE2Ont_Leafs_tmp.DataType = row42.name;
							...
							tMap6DE2Ont_Leafs_tmp.item = null;
						...
						if (tMap6DE2Ont_Leafs != null) {
							...
							consoleOut_tLogRow_25.println(strBuffer_tLogRow_25
									.toString());
	...
	public static void main(String[] args) {
		final MDR_Query_DataElements_dataType MDR_Query_DataElements_dataTypeClass = new MDR_Query_DataElements_dataType();

		int exitCode = MDR_Query_DataElements_dataTypeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MDR_Query_DataElements_dataType.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/mdr_query_dataelements_datatype_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : MDR_Query_DataElements_dataType");
		}
...
/************************************************************************************************
 * 131785 characters generated by Talend Open Studio for Data Integration on the
