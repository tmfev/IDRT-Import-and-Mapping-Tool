...
package i2b2_postgres2.mdr_query_dataelements_unitofmeasure_0_1;
...
/**
 * Job: MDR_Query_DataElements_unitOfMeasure Purpose: Fragt mit MDRID (aus Context) MDR ab und liefert Ergebnisse (gefiltert)<br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class MDR_Query_DataElements_unitOfMeasure implements TalendJob {
	...
	private final String jobName = "MDR_Query_DataElements_unitOfMeasure";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MDR_Query_DataElements_unitOfMeasure.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MDR_Query_DataElements_unitOfMeasure.this,
	...
	public static class row52Struct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure.length == 0) {
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_MDR_Query_DataElements_unitOfMeasure) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fileName_tFileOutputDelimited_17 = (new java.io.File(
						context.folderMain + context.folderTemp + "ont_mu"
				...
				fileName_tFileOutputDelimited_16 = (new java.io.File(
						context.folderMain + context.folderTemp + "temp_mu"
								+ context.DE_domain_ID + ".csv"))
						.getAbsolutePath().replace("\\", "/");
					...
					if (row42 != null) {
						...
						{ // start of Var scope
							...
							tMap6DE2Ont_Leafs_tmp.Path = context.ont_03_Path
									+ "\\" + Var.itemID + "\\";
							tMap6DE2Ont_Leafs_tmp.DataType = null;
							...
							tMap6DE2Ont_Leafs_tmp.xml = null;
	...
	public static void main(String[] args) {
		final MDR_Query_DataElements_unitOfMeasure MDR_Query_DataElements_unitOfMeasureClass = new MDR_Query_DataElements_unitOfMeasure();

		int exitCode = MDR_Query_DataElements_unitOfMeasureClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MDR_Query_DataElements_unitOfMeasure.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/mdr_query_dataelements_unitofmeasure_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : MDR_Query_DataElements_unitOfMeasure");
		}
...
/************************************************************************************************
 * 132950 characters generated by Talend Open Studio for Data Integration on the
