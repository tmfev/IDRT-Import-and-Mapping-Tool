...
package i2b2_postgres2.mdr_create_conceptdimension_0_1;
...
/**
 * Job: MDR_Create_ConceptDimension Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.1.20141207_1530
 * @status 
 */
public class MDR_Create_ConceptDimension implements TalendJob {
	...
	private final String jobName = "MDR_Create_ConceptDimension";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MDR_Create_ConceptDimension.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MDR_Create_ConceptDimension.this,
	...
	public static class toCDStruct implements
		...
		final static byte[] commonByteArrayLock_I2B2_POSTGRES2_MDR_Create_ConceptDimension = new byte[0];
		static byte[] commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension.length) {
					if (length < 1024
							&& commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension.length == 0) {
						commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension = new byte[1024];
					} else {
						commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_I2B2_POSTGRES2_MDR_Create_ConceptDimension,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_I2B2_POSTGRES2_MDR_Create_ConceptDimension) {
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				 ...
				 */
				context.folderMain + context.folderOutput + context.fileOnt/**
				 * End
					...
					while (limittFileInputDelimited_2 != 0
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Path = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.DataType = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.PathID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.visual = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.codeList = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.xml = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.m_applied_path = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								((String) row1.visual).startsWith("L")

								) {
									toCD_tmp.CONCEPT_PATH = row1.Path;
									toCD_tmp.CONCEPT_CD = ((String) ((String) row1.Path
											.subSequence(6,
													((String) row1.Path)
															.lastIndexOf('\\')))
											+ ":" + ((String) row1.Path
											.substring(((String) row1.Path)
													.lastIndexOf('\\') + 1)))
											.replace('\\', '|');
									toCD_tmp.NAME_CHAR = row1.Name;
									toCD_tmp.CONCEPT_BLOB = null;
									toCD_tmp.UPDATE_DATE = row1.Update_Date;
									toCD_tmp.DOWNLOAD_DATE = row1.Download_Date;
									toCD_tmp.IMPORT_DATE = row1.Import_Date;
									toCD_tmp.SOURCESYSTEM_CD = row1.source;
									toCD_tmp.UPLOAD_ID = "007";
									toCD = toCD_tmp;
	...
	public static void main(String[] args) {
		final MDR_Create_ConceptDimension MDR_Create_ConceptDimensionClass = new MDR_Create_ConceptDimension();

		int exitCode = MDR_Create_ConceptDimensionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MDR_Create_ConceptDimension.class
					.getClassLoader().getResourceAsStream(
							"i2b2_postgres2/mdr_create_conceptdimension_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : MDR_Create_ConceptDimension");
		}
...
/************************************************************************************************
 * 70169 characters generated by Talend Open Studio for Data Integration on the
