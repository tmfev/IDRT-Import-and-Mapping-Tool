...
package idrt52.server_freelocks_0_1;
...
public class SERVER_FreeLocks implements TalendJob {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_SERVER_FreeLocks = new byte[0];
		static byte[] commonByteArray_IDRT52_SERVER_FreeLocks = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_SERVER_FreeLocks.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_SERVER_FreeLocks.length == 0) {
						commonByteArray_IDRT52_SERVER_FreeLocks = new byte[1024];
					} else {
						commonByteArray_IDRT52_SERVER_FreeLocks = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_SERVER_FreeLocks, 0,
						length);
				strReturn = new String(commonByteArray_IDRT52_SERVER_FreeLocks,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_SERVER_FreeLocks) {
		...
		try {
			...
			java.io.InputStream inContext = SERVER_FreeLocks.class
					.getClassLoader().getResourceAsStream(
							"idrt52/server_freelocks_0_1/contexts/"
...
/************************************************************************************************
 * 42702 characters generated by Talend Open Studio for Data Integration on the
 * September 27, 2013 9:00:45 AM CEST
 ************************************************************************************************/
