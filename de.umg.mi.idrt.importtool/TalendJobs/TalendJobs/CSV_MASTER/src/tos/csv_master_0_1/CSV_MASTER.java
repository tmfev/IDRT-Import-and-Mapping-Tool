...
public class CSV_MASTER implements TalendJob {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_1.add("--context=TestServer");
				...
				tos.csv_import_0_1.CSV_Import childJob_tRunJob_1 = new tos.csv_import_0_1.CSV_Import();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_5.add("--context=TestServer");
				...
				tos.csv_patient_data_0_1.CSV_Patient_Data childJob_tRunJob_5 = new tos.csv_patient_data_0_1.CSV_Patient_Data();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_6.add("--context=TestServer");
				...
				parentContextMap_tRunJob_6.put("DB_StagingI2B2_Schema",
						context.DB_StagingI2B2_Schema);
				parentContextMap_tRunJob_6.put("DB_StagingI2B2_sqlclassname",
						context.DB_StagingI2B2_sqlclassname);
				...
				tos.idrt_truncate_tables_0_1.IDRT_Truncate_Tables childJob_tRunJob_6 = new tos.idrt_truncate_tables_0_1.IDRT_Truncate_Tables();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_8.add("--context=TestServer");
				...
				parentContextMap_tRunJob_8.put("DB_StagingI2B2_Schema",
						context.DB_StagingI2B2_Schema);
				parentContextMap_tRunJob_8.put("DB_StagingI2B2_sqlclassname",
						context.DB_StagingI2B2_sqlclassname);
				...
				tos.idrt_delete_patients_0_1.IDRT_Delete_Patients childJob_tRunJob_8 = new tos.idrt_delete_patients_0_1.IDRT_Delete_Patients();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_9.add("--context=TestServer");
				...
				parentContextMap_tRunJob_9.put("DB_StagingI2B2_Schema",
						context.DB_StagingI2B2_Schema);
				parentContextMap_tRunJob_9.put("DB_StagingI2B2_sqlclassname",
						context.DB_StagingI2B2_sqlclassname);
				...
				tos.pidgenerator_0_1.PidGenerator childJob_tRunJob_9 = new tos.pidgenerator_0_1.PidGenerator();
				// pass DataSources
	...
	public static class row21Struct implements
		...
		final static byte[] commonByteArrayLock_TOS_CSV_MASTER = new byte[0];
		static byte[] commonByteArray_TOS_CSV_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TOS_CSV_MASTER.length) {
					if (length < 1024
							&& commonByteArray_TOS_CSV_MASTER.length == 0) {
						commonByteArray_TOS_CSV_MASTER = new byte[1024];
					} else {
						commonByteArray_TOS_CSV_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TOS_CSV_MASTER, 0, length);
				strReturn = new String(commonByteArray_TOS_CSV_MASTER, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TOS_CSV_MASTER) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CSV_MASTER.class.getClassLoader()
					.getResourceAsStream(
							"tos/csv_master_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 193105 characters generated by Talend Open Studio for Data Integration on the
 * July 30, 2014 3:47:49 PM CEST
 ************************************************************************************************/
