...
public class ODM_MASTER implements TalendJob {
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.odm_extract_pd_0_1.ODM_Extract_PD childJob_tRunJob_2 = new idrt52.odm_extract_pd_0_1.ODM_Extract_PD();
				// pass DataSources
	...
	public static class row14Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_ODM_MASTER = new byte[0];
		static byte[] commonByteArray_IDRT52_ODM_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_ODM_MASTER.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_ODM_MASTER.length == 0) {
						commonByteArray_IDRT52_ODM_MASTER = new byte[1024];
					} else {
						commonByteArray_IDRT52_ODM_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_ODM_MASTER, 0, length);
				strReturn = new String(commonByteArray_IDRT52_ODM_MASTER, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_ODM_MASTER) {
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.idrt_truncate_tables_0_1.IDRT_Truncate_Tables childJob_tRunJob_12 = new idrt52.idrt_truncate_tables_0_1.IDRT_Truncate_Tables();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.odm_extract_pd_with_xslt_0_1.ODM_Extract_PD_With_XSLT childJob_tRunJob_5 = new idrt52.odm_extract_pd_with_xslt_0_1.ODM_Extract_PD_With_XSLT();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.odm_create_ontology_1_1.ODM_Create_Ontology childJob_tRunJob_1 = new idrt52.odm_create_ontology_1_1.ODM_Create_Ontology();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.idrt_delete_patients_0_1.IDRT_Delete_Patients childJob_tRunJob_10 = new idrt52.idrt_delete_patients_0_1.IDRT_Delete_Patients();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ODM_MASTER.class.getClassLoader()
					.getResourceAsStream(
							"idrt52/odm_master_0_1/contexts/" + contextStr
									+ ".properties");
 ...
 * September 26, 2013 11:49:14 AM CEST
 ************************************************************************************************/
