...
package idrt52.idrt_transformation_0_5;
...
public class IDRT_TRANSFORMATION implements TalendJob {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_IDRT_TRANSFORMATION = new byte[0];
		static byte[] commonByteArray_IDRT52_IDRT_TRANSFORMATION = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_IDRT_TRANSFORMATION.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_IDRT_TRANSFORMATION.length == 0) {
						commonByteArray_IDRT52_IDRT_TRANSFORMATION = new byte[1024];
					} else {
						commonByteArray_IDRT52_IDRT_TRANSFORMATION = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_IDRT_TRANSFORMATION, 0,
						length);
				strReturn = new String(
						commonByteArray_IDRT52_IDRT_TRANSFORMATION, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_IDRT_TRANSFORMATION) {
		...
		try {
			...
			java.io.InputStream inContext = IDRT_TRANSFORMATION.class
					.getClassLoader().getResourceAsStream(
							"idrt52/idrt_transformation_0_5/contexts/"
...
/************************************************************************************************
 * 144733 characters generated by Talend Open Studio for Data Integration on the
 * September 26, 2013 11:49:03 AM CEST
 ************************************************************************************************/
