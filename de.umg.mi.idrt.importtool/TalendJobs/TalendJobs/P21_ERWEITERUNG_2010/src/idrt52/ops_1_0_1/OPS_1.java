...
public class OPS_1 implements TalendJob {
	...
	public static class ops_outStruct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_OPS_1 = new byte[0];
		static byte[] commonByteArray_IDRT52_OPS_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_OPS_1.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_OPS_1.length == 0) {
						commonByteArray_IDRT52_OPS_1 = new byte[1024];
					} else {
						commonByteArray_IDRT52_OPS_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_OPS_1, 0, length);
				strReturn = new String(commonByteArray_IDRT52_OPS_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_OPS_1) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = OPS_1.class.getClassLoader()
					.getResourceAsStream(
							"idrt52/ops_1_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 98043 characters generated by Talend Open Studio for Data Integration on the
 * September 26, 2013 11:49:23 AM CEST
 ************************************************************************************************/
