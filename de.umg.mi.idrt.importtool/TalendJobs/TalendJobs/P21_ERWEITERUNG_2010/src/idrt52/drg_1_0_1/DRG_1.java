...
public class DRG_1 implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_DRG_1 = new byte[0];
		static byte[] commonByteArray_IDRT52_DRG_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_DRG_1.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_DRG_1.length == 0) {
						commonByteArray_IDRT52_DRG_1 = new byte[1024];
					} else {
						commonByteArray_IDRT52_DRG_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_DRG_1, 0, length);
				strReturn = new String(commonByteArray_IDRT52_DRG_1, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_DRG_1) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = DRG_1.class.getClassLoader()
					.getResourceAsStream(
							"idrt52/drg_1_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 127514 characters generated by Talend Open Studio for Data Integration on the
 * September 26, 2013 11:49:22 AM CEST
 ************************************************************************************************/
