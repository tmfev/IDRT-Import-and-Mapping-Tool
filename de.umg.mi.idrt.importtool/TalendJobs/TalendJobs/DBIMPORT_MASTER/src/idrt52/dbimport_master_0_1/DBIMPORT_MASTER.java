...
package idrt52.dbimport_master_0_1;
...
public class DBIMPORT_MASTER implements TalendJob {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_DBIMPORT_MASTER = new byte[0];
		static byte[] commonByteArray_IDRT52_DBIMPORT_MASTER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_DBIMPORT_MASTER.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_DBIMPORT_MASTER.length == 0) {
						commonByteArray_IDRT52_DBIMPORT_MASTER = new byte[1024];
					} else {
						commonByteArray_IDRT52_DBIMPORT_MASTER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_DBIMPORT_MASTER, 0, length);
				strReturn = new String(commonByteArray_IDRT52_DBIMPORT_MASTER,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_DBIMPORT_MASTER) {
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.csv_master_0_1.CSV_MASTER childJob_tRunJob_2 = new idrt52.csv_master_0_1.CSV_MASTER();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = DBIMPORT_MASTER.class
					.getClassLoader().getResourceAsStream(
							"idrt52/dbimport_master_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 85533 characters generated by Talend Open Studio for Data Integration on the
