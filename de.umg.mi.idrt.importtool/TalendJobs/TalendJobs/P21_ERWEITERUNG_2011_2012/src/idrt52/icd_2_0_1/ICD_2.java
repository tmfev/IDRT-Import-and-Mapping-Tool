...
public class ICD_2 implements TalendJob {
	...
	public static class out2Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_ICD_2 = new byte[0];
		static byte[] commonByteArray_IDRT52_ICD_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_ICD_2.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_ICD_2.length == 0) {
						commonByteArray_IDRT52_ICD_2 = new byte[1024];
					} else {
						commonByteArray_IDRT52_ICD_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_ICD_2, 0, length);
				strReturn = new String(commonByteArray_IDRT52_ICD_2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_ICD_2) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ICD_2.class.getClassLoader()
					.getResourceAsStream(
							"idrt52/icd_2_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 99632 characters generated by Talend Open Studio for Data Integration on the
