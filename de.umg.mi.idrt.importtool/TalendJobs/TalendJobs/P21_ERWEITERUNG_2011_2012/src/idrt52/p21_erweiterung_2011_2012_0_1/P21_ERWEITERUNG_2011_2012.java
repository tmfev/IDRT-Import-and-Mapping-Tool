...
package idrt52.p21_erweiterung_2011_2012_0_1;
...
public class P21_ERWEITERUNG_2011_2012 implements TalendJob {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.icd_2_0_1.ICD_2 childJob_tRunJob_1 = new idrt52.icd_2_0_1.ICD_2();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.ops_2_0_1.OPS_2 childJob_tRunJob_2 = new idrt52.ops_2_0_1.OPS_2();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				idrt52.fab_2_0_1.FAB_2 childJob_tRunJob_3 = new idrt52.fab_2_0_1.FAB_2();
				// pass DataSources
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_IDRT52_P21_ERWEITERUNG_2011_2012 = new byte[0];
		static byte[] commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012.length) {
					if (length < 1024
							&& commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012.length == 0) {
						commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012 = new byte[1024];
					} else {
						commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012,
						0, length);
				strReturn = new String(
						commonByteArray_IDRT52_P21_ERWEITERUNG_2011_2012, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IDRT52_P21_ERWEITERUNG_2011_2012) {
		...
		try {
			...
			java.io.InputStream inContext = P21_ERWEITERUNG_2011_2012.class
					.getClassLoader().getResourceAsStream(
							"idrt52/p21_erweiterung_2011_2012_0_1/contexts/"
...
/************************************************************************************************
 * 93674 characters generated by Talend Open Studio for Data Integration on the
